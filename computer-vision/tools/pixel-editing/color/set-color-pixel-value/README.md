<h1>Set Color Pixel Value</h1>

<h2>Description</h2>

<p>Changes a pixel value in a color image. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/96/967eb69f61fd-set_color_pixel_value.png" alt="Set_Color_Pixel_Value.Png" width="237" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top">Pixel Value : <em>integer, </em>pixel value as an unsigned 32-bit integer.</td>
    </tr>
  </tbody>
</table>
