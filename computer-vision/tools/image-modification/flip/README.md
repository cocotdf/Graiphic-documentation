...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top">Flip Code :<em> enum, </em>specifies the symmetry used.
<ul>
<li>
<ul>
<li>Horizontal Flip : based on the horizontal axis of the image</li>
<li>Vertical Flip : based on the vertical axis of the image</li>
<li>Horizontal+Vertical Flip : based on the horizontal and vertical axis of the image</li>
</ul>
</li>
</ul></td>
    </tr>
