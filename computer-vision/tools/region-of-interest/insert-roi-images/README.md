<h1>Insert ROI Images</h1>

<h2>Description</h2>

<p>Inserts multiple images in the Src Image. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/32/3278060a337b-insert_roi_images.png" alt="Insert_Roi_Images.Png" width="254" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>Images Insert : <em>array, </em></strong>type accepted <strong>U8</strong>, <strong>I16</strong>, <strong>RGB</strong> and <strong>HSL</strong>.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>ROI Descriptor : <em>cluster, </em></strong>descriptor that defines regions of interests used to position images.</td>
    </tr>
    <tr>
      <td></td>
      <td valign="top"><table>
