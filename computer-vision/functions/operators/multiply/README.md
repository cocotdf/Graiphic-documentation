...
<p align="center"><img src="/_assets/shared-images/bc/bcc55b24aa2a-divide.png" alt="Multiply.Png" width="245" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top">Scale :<em> float, </em>value multiplied by <strong>Image Src A</strong> for image-constant operations. Scale must be a RGB color value when <strong>Image Src A</strong> is a color image.</td>
    </tr>
  </tbody>
</table>
