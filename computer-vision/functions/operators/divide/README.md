...
<p>Divides one image by another image or an image by a constant. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/bc/bcc55b24aa2a-divide.png" alt="Divide.Png" width="245" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top">Scale :<em> float, </em>value that divides <strong>Image Src A</strong> for image-constant operations. Scale must be a RGB color value when <strong>Image Src A</strong> is a color image.</td>
    </tr>
  </tbody>
</table>
