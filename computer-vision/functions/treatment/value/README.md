...
<p>Adjust the value in the image.​ Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/13/13f5c5ccbe47-value.png" alt="Value.Png" width="234" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>value : <em>integer</em>, </strong>parameter representing value in HSV format.</td>
    </tr>
  </tbody>
</table>
