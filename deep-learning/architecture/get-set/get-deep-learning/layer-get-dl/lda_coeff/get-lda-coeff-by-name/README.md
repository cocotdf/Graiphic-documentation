<h1>Get “lda_coeff” by name</h1>

<h2>Description</h2>

<p>Gets the loss derivative attenuation coefficient of layer selected by the name given as input.</p>

<p align="center"><img alt="get_lda_coef_by_name" src="/_assets/shared-images/8a/8ae1e4d23b04-get_lda_coef_by_name.png" width="220"/></p>
...
<p>All these exemples are snippets PNG, you can drop these Snippet onto the block diagram and get the depicted code added to your VI (Do not forget to install Deep Learning to run it).</p>

<h3>Using the “Get lda_coeff by name” function</h3>

<p align="center"><img alt="get_lda_coeff_by_name" src="assets/get_lda_coeff_by_name.png" width="220"/></p>
...
<p>We use the “Get lda_coeff by name” function to get the value of the parameter of layer named Dense2.</p>
