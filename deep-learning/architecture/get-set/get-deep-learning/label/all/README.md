<h1>Get all index/name</h1>

<h2>Description</h2>

<p>Gets the index and name of all layers contained in the model.</p>

<p align="center"><img alt="get_all_index" src="/_assets/shared-images/cd/cdc4aadce2c2-get_all_index.png" width="220"/></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>index_array : <em>array</em></strong></td>
    </tr>
    <tr>
      <td></td>
      <td valign="top"><table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="index_array" src="assets/index_array.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<h3>Using the “Get All Index/Name” function</h3>

<p align="center"><img alt="get_all_index_name" src="assets/get_all_index_name.png" width="220"/></p>
...
<p>We use the function “Get All Index/Name” to get the indexes and names of all layers contained in the model.</p>
