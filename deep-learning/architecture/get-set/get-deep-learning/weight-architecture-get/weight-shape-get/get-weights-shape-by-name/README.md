<h1>Get weights shape by name</h1>

<h2>Description</h2>

<p>Gets the shape of the weights of the layer selected by the name given as input.</p>

<p align="center"><img alt="get_weight_shape_by_name" src="/_assets/shared-images/99/991694ae4f9f-get_weight_shape_by_name.png" width="220"/></p>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="Cluster Out.Png" src="/_assets/shared-images/0a/0a479d27b394-cluster-out.png" width="32"/><strong>weight_shape : <em>cluster</em></strong></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="weight_shape" src="/_assets/shared-images/cf/cff59497f4d0-weight_shape.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
