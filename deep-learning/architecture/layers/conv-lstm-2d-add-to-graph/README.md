...
<p>Setup and add the convolution lstm 2D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/fa/fa347b0eb877-conv_lstm_2d_add_to_graph.png" alt="Conv_Lstm_2D_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>size : <em>array</em></strong>, specify the dimensions of the convolution window.</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
      <td valign="top">Default value “[3,3]”.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Array Integer 32.Png" src="/_assets/shared-images/90/90ecefc445f7-array-integer-32.png" width="42"/></td>
      <td valign="top"><strong>stride : <em>array</em></strong>, specify the strides of the convolution.</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="assets/conv_lstm_2d_param.png" alt="conv_lstm_2d_param" width="172" /></p></td>
    </tr>
  </tbody>
</table>
...
<ul>
<li>If data_format = ‘channels_last’ : (samples, time, rows, cols, channels).</li>
<li>If data_format = ‘channels_first’ : (samples, time, channels, rows, cols).</li>
</ul>
...
<li>
<ul>
<li>If data_format = ‘channels_last’ : 5D tensor with shape (samples, timesteps, new_rows, new_cols, filters).</li>
<li>If data_format = ‘channels_first’ : 5D tensor with shape (samples, timesteps, filters, new_rows, new_cols).</li>
</ul>
</li>
</ul>
...
<li>
<ul>
<li>If data_format = ‘channels_last’ : 4D tensor with shape (samples, new_rows, new_cols, filters).</li>
<li>If data_format = ‘channels_first’ : 4D tensor with shape (samples, filters, new_rows, new_cols).</li>
</ul>
</li>
</ul>
...
<h3>ConvLSTM2D layer</h3>

<p align="center"><img src="assets/1-convlstm2d-layer.png" alt="1 - ConvLSTM2D layer" width="260" /></p>

<p>1 – Generate a set of data</p>

<p>We generate an array of data of type single and shape [samples = 10, time = 7, channels = 6, rows = 5, cols = 5].</p>

<p>2 – Define graph</p>

<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [time = 7, channels = 6, rows = 5, cols = 5].<br/>Then we add to the graph the ConvLSTM2D layer.</p>

<p>3 – Run graph</p>

<p>We call the forward method and retrieve the result with the “Prediction 4D” method.<br/>This method returns two variables, the first one is the layer information (cluster composed of the layer name, the graph index and the shape of the output layer) and the second one is the prediction with a shape of [samples, filters, new_rows, new_cols].<br/>The output dimension depends on the parameters “return-sequences” refer to the chapter “Dimension” of this documentation.</p>

<h3>ConvLSTM2D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-convlstm2d-batch-and-dimension.png" alt="2 - ConvLSTM2D batch and dimension" width="260" /></p>

<p>1 – Generate a set of data</p>

<p>We generate an array of data of type single and shape [number of batch = 9, samples = 10, time = 7, channels = 6, rows = 5, cols = 5].</p>
