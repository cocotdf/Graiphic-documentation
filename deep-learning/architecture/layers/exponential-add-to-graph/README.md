...
<p>Setup and add exponential layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/1a/1a5a92acebcf-expoential_add_to_graph.png" alt="Expoential_Add_To_Graph.Png" width="265" /></p>
...
<h3>Exponential layer</h3>

<p align="center"><img src="assets/1-exponential-layer.png" alt="1 - Exponential layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the Exponential layer.</p>
...
<h3>Exponential layer, batch and dimension</h3>

<p align="center"><img src="assets/2-exponential-layer-batch-and-dimension.png" alt="2 - Exponential layer batch and dimension" width="260" /></p>
