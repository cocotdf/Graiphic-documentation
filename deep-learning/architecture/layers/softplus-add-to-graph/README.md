...
<p>Setup and add softplus layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/2b/2b9591d4804a-softplus_add_to_graph.png" alt="Softplus_Add_To_Graph.Png" width="265" /></p>
...
<h3>SoftPlus layer</h3>

<p align="center"><img src="assets/1-softplus-layer.png" alt="1 - SoftPlus layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the SoftPlus layer.</p>
...
<h3>SoftPlus layer, batch and dimension</h3>

<p align="center"><img src="assets/2-softplus-layer-batch-and-dimension.png" alt="2 - SoftPlus layer batch and dimension" width="260" /></p>
