...
<p>Setup and add selu layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/b4/b4247532fac5-selu_add_to_graph.png" alt="Selu_Add_To_Graph.Png" width="265" /></p>
...
<p align="center"><img src="assets/1-selu-layer.png" alt="1 - SELU layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the SELU layer.</p>
...
<h3>SELU layer, batch and dimension</h3>

<p align="center"><img src="assets/2-selu-layer-batch-and-dimension.png" alt="2 - SELU layer batch and dimension" width="260" /></p>
