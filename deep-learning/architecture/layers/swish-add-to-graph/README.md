...
<p>Setup and add swish layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/2e/2ec16bc1f3c1-swish_add_to_graph.png" alt="Swish_Add_To_Graph.Png" width="265" /></p>
...
<p align="center"><img src="assets/1-swish-layer.png" alt="1 - Swish layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the Swish layer.</p>
...
<h3>Swish layer, batch and dimension</h3>

<p align="center"><img src="assets/2-swish-layer-batch-and-dimension.png" alt="2 - Swish layer batch and dimension" width="260" /></p>
