...
<p>Setup and add prelu layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/63/6325781e80f1-prelu_add_to_graph.png" alt="Prelu_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>shared_axes : <em>array integer</em></strong>, the axes along which to share learnable parameters for the activation function.</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
      <td valign="top">Default value “[]” (empty array is equivalent to “None” and axis = 0 is equivalent to axis = -1).</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Cluster.Png" src="../../../../_resolved/and/assets/cluster.png" width="42"/></td>
      <td valign="top"><strong> <a href="../../../more-deep-learning/layers-parameters/optimizer/README.md">Optimizer</a> : <em>cluster, </em></strong>optimizer for the weights.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Cluster.Png" src="../../../../_resolved/and/assets/cluster.png" width="42"/></td>
      <td valign="top"><strong><a href="../../../more-deep-learning/layers-parameters/initializer/README.md">Alpha Initializer</a> : <em>cluster, </em></strong>initializer for the weights.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Cluster.Png" src="../../../../_resolved/and/assets/cluster.png" width="42"/></td>
      <td valign="top"><strong><a href="../../../more-deep-learning/layers-parameters/regularizer/README.md">Alpha Regularizer</a> : <em>cluster, </em></strong>regularizer for the weights.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="assets/param_prelu.png" alt="param_prelu" width="201" /></p></td>
    </tr>
  </tbody>
</table>
...
<p align="center"><img src="assets/1-prelu-layer.png" alt="1 - PReLU layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the PReLU layer.</p>
...
<h3>PReLU layer, batch and dimension</h3>

<p align="center"><img src="assets/2-prelu-layer-batch-and-dimension.png" alt="2 - PReLU layer batch and dimension" width="260" /></p>
