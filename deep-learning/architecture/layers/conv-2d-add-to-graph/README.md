...
<p>Setup and add the convolution 2D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/57/5727cb793a0c-separable_conv_2d_add_to_graph.png" alt="Separable_Conv_2D_Add_To_Graph.Png" width="265" /></p>
...
<h3>Convolution 2D layer</h3>

<p align="center"><img src="assets/1-conv2d-layer.png" alt="1 - Conv2D layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [channel = 5, row = 128, column = 128]. <br/>Then we add to the graph the Conv2D layer.</p>
...
<h3>Convolution 2D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-conv2d-batch-and-dimension.png" alt="2 - Conv2D batch and dimension" width="260" /></p>
