...
<p align="center"><img src="/_assets/shared-images/3f/3fd6565ccd7b-softmax_add_to_graph.png" alt="Softmax_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>axis : <em>integer</em></strong>, axis along which the softmax normalization is applied.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="/_assets/shared-images/8a/8ab93949bb7f-param_define_with_axis.png" alt="param_define_with_axis" width="79" /></p></td>
    </tr>
  </tbody>
</table>
...
<p align="center"><img src="assets/1-softmax-layer.png" alt="1 - SoftMax layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the SoftMax layer.</p>
...
<h3>SoftMax layer, batch and dimension</h3>

<p align="center"><img src="assets/2-softmax-layer-batch-and-dimension.png" alt="2 - SoftMax layer batch and dimension" width="260" /></p>
