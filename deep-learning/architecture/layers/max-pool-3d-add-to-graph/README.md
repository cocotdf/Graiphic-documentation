...
<h3>MaxPool3D layer</h3>

<p align="center"><img src="assets/1-maxpool3d-layer.png" alt="1 - MaxPool3D layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [channels = 7, spatial_dim1 = 5, spatial_dim2 = 5, spatial_dim3 = 3].<br/>Then we add to the graph the MaxPool3D layer.</p>
...
<h3>MaxPool3D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-maxpool3d-batch-and-dimension.png" alt="2 - MaxPool3D batch and dimension" width="260" /></p>

<p>1 – Generate a set of data</p>

<p>We generate an array of data of type single and shape [numberof batch = 9, batch_size = 10, channels = 7, spatial_dim1 = 5, spatial_dim2 = 5, spatial_dim3 = 3].</p>
