...
<p>Setup and add linear layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/86/8619f584bbac-linear_add_to_graph.png" alt="Linear_Add_To_Graph.Png" width="265" /></p>
...
<p align="center"><img src="assets/1-linear-layer.png" alt="1 - Linear layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the Linear layer.</p>
...
<h3>Linear layer, batch and dimension</h3>

<p align="center"><img src="assets/2-linear-layer-batch-and-dimension.png" alt="2 - Linear layer batch and dimension" width="260" /></p>
