...
<p align="center"><img src="/_assets/shared-images/1f/1f30939e6fcf-gaussian_noise_add_to_graph.png" alt="Gaussian_Noise_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>stddev : <em>float</em></strong>, standard deviation of the noise distribution.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="assets/param_gaussian_noise.png" alt="param_gaussian_noise" width="79" /></p></td>
    </tr>
  </tbody>
</table>
...
<h3>GaussianNoise layer</h3>

<p align="center"><img src="assets/1-gaussiannoise-layer.png" alt="1 - GaussianNoise layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5]. <br/>Then we add to the graph the GaussianNoise layer.</p>
...
<h3>GaussianNoise layer, batch and dimension</h3>

<p align="center"><img src="assets/2-gaussiannoise-batch-and-dimension.png" alt="2 - GaussianNoise batch and dimension" width="260" /></p>
