...
<p align="center"><img src="/_assets/shared-images/9a/9a187eff70e5-alpha_dropout_add_to_graph.png" alt="Gaussian_Dropout_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>rate : <em>float, </em></strong>drop probability(as with <strong>Dropout</strong>). The multiplicative noise will have standard <strong>deviation sqrt(rate / (1 – rate)).</strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="/_assets/shared-images/d1/d173ed237a6a-dropout_param.png" alt="dropout_param" width="79" /></p></td>
    </tr>
  </tbody>
</table>
...
<h3>GaussianDropout layer</h3>

<p align="center"><img src="assets/1-gaussiandropout-layer.png" alt="1 - GaussianDropout layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5]. <br/>Then we add to the graph the GaussianDropout layer.</p>
...
<h3>GaussianDropout layer, batch and dimension</h3>

<p align="center"><img src="assets/2-gaussiandropout-batch-and-dimension.png" alt="2 - GaussianDropout batch and dimension" width="260" /></p>
