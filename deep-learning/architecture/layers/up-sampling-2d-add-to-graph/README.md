...
<p>Setup and add the up sampling 2D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/f5/f5ac27e4f792-up_sampling_2d_add_to_graph.png" alt="Up_Sampling_2D_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>size : <em>array integers</em></strong>, the upsampling factors for rows and columns.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="assets/param_upsampling_2d.png" alt="param_upsampling_2d" width="106" /></p></td>
    </tr>
  </tbody>
</table>
...
<ul>
<li>If data_format = ‘channels_last’ : (batch_size, upsampled_rows, upsampled_cols, channels).</li>
<li>If data_format = ‘channels_first’ : (batch_size, channels, upsampled_rows, upsampled_cols).</li>
</ul>
...
<h3>UpSampling2D layer</h3>

<p align="center"><img src="assets/1-upsampling2d-layer.png" alt="1 - UpSampling2D layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [channels = 7, rows = 5, cols = 3].<br/>Then we add to the graph the UpSampling2D layer.</p>

<p>3 – Run graph</p>

<p>We call the forward method and retrieve the result with the “Prediction 4D” method.<br/>This method returns two variables, the first one is the layer information (cluster composed of the layer name, the graph index and the shape of the output layer) and the second one is the prediction with a shape of [batch_size, channels, upsampled_rows, upsampled_cols].</p>

<h3>UpSampling2D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-upsampling2d-batch-and-dimension.png" alt="2 - Upsampling2D batch and dimension" width="260" /></p>
