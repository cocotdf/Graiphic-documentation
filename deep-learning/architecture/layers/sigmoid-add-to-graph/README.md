...
<p>Setup and add sigmoid layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/1f/1fe20166c60a-sigmoid_add_to_graph.png" alt="Sigmoid_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>lda coeff</strong><strong> :</strong> <em><strong>float</strong></em>, defines the coefficient by which the loss derivative will be multiplied before being sent to the previous layer (since during the backward run we go backwards).</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
...
<p align="center"><img src="assets/1-sigmoid-layer.png" alt="1 - Sigmoid layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the Sigmoid layer.</p>
...
<h3>Sigmoid layer, batch and dimension</h3>

<p align="center"><img src="assets/2-sigmoid-layer-batch-and-dimension.png" alt="2 - Sigmoid layer batch and dimension" width="260" /></p>
