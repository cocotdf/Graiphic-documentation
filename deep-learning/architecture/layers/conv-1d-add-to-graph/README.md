...
<p>Setup and add the convolution 1D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/18/18e6e72b8b9c-separable_conv_1d_add_to_graph.png" alt="Separable_Conv_1D_Add_To_Graph.Png" width="265" /></p>
...
<p>3-Dimension tensor with shape : [batch_size, channel, width] (default “channel_first” parameters).<br/>In case of “channel_last” setup, forward function will input shape [batch_size, width, channel].</p>
...
<h3>Convolution 1D layer</h3>

<p align="center"><img src="assets/1-conv1d-layer.png" alt="1 - Conv1D layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [channel = 5, width = 128]. <br/>Then we add to the graph the Conv1D layer.</p>
...
<h3>Convolution 1D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-conv1d-batch-and-dimension.png" alt="2 - Conv1D batch and dimension" width="260" /></p>
