...
<p>Setup and add leaky relu layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/44/443b5c82b53e-leaky_relu_add_to_graph.png" alt="Leaky_Relu_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>alpha : <em>float &gt;= 0</em></strong>, negative slope coefficient.</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
      <td valign="top">Default value “0.3”.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="/_assets/shared-images/30/305259ee444a-param_define_with_alpha.png" alt="param_define_with_alpha" width="79" /></p></td>
    </tr>
  </tbody>
</table>
...
<h3>LeakyReLU layer</h3>

<p align="center"><img src="assets/1-leakyrelu-layer.png" alt="1 - LeakyReLU layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the LeakyReLU layer.</p>
...
<h3>LeakyReLU layer, batch and dimension</h3>

<p align="center"><img src="assets/2-leakyrelu-layer-batch-and-dimension.png" alt="2 - LeakyReLU layer batch and dimension" width="260" /></p>
