...
<p>Setup and add the convolution 3D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/b4/b45b546219f9-conv_3d_add_to_graph.png" alt="Conv_3D_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="/_assets/shared-images/75/757470a85c65-conv_3d_param.png" alt="conv_3d_param" width="162" /></p></td>
    </tr>
  </tbody>
</table>
...
<h3>Convolution 3D layer layer</h3>

<p align="center"><img src="assets/1-conv3d-layer.png" alt="1 - Conv3D layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [channel = 5, conv_dim1 = 64, conv_dim2 = 64, conv_dim3 = 3]. <br/>Then we add to the graph the Conv3D layer.</p>
...
<h3>Convolution 3D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-conv3d-batch-and-dimension.png" alt="2 - Conv3D batch and dimension" width="260" /></p>
