...
<p>Setup and add the zero padding 2D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/16/1668931f87f4-zero_padding_2d_add_to_graph.png" alt="Zero_Padding_2D_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="assets/param_zeropadding_2d.png" alt="param_zeropadding_2d" width="158" /></p></td>
    </tr>
  </tbody>
</table>
...
<ul>
<li>If data_format is “channels_last” : (batch_size, padded_rows, padded_cols, channels)</li>
<li>If data_format is “channels_first” : (batch_size, channels, padded_rows, padded_cols)</li>
</ul>
...
<h3>ZeroPadding2D layer</h3>

<p align="center"><img src="assets/1-zeropadding2d-layer.png" alt="1 - ZeroPadding2D layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [channels = 7, rows = 5, cols = 3].<br/>Then we add to the graph the ZeroPadding2D layer.</p>

<p>3 – Run graph</p>

<p>We call the forward method and retrieve the result with the “Prediction 4D” method.<br/>This method returns two variables, the first one is the layer information (cluster composed of the layer name, the graph index and the shape of the output layer) and the second one is the prediction with a shape of [batch_size, channels, padded_rows, padded_cols].</p>

<h3>ZeroPadding2D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-zeropadding2d-batch-and-dimension.png" alt="2 - ZeroPadding2D batch and dimension" width="260" /></p>
