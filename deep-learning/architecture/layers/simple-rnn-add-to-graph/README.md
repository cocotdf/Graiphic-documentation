...
<p>Setup and add the simple rnn layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/5c/5c7c3948c365-simple_rnn_add_to_graph.png" alt="Simple_Rnn_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="assets/param_simple_rnn.png" alt="param_simple_rnn" width="201" /></p></td>
    </tr>
  </tbody>
</table>
...
<h3>SimpleRNN layer</h3>

<p align="center"><img src="assets/1-simple-rnn-layer.png" alt="1 - Simple RNN layer" width="260" /></p>

<p>1 – Generate a set of data</p>

<p>We generate an array of data of type single and shape [batch_size = 10, timesteps = 7, features = 3].</p>

<p>2 – Define graph</p>

<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [timesteps = 7, features = 3].<br/>Then we add to the graph the SimpleRNN layer.</p>
...
<h3>SimpleRNN layer, batch and dimension</h3>

<p align="center"><img src="assets/2-simple-rnn-batch-and-dimension.png" alt="2 - Simple RNN batch and dimension" width="260" /></p>
