<h1>GlobalMaxPool2D</h1>

<h2>Description</h2>

<p>Setup and add the global max pooling 2D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/e7/e7b06fa30aac-global_max_pool_2d_add_to_graph.png" alt="Global_Max_Pool_2D_Add_To_Graph.Png" width="265" /></p>
...
<h3>GlobalMaxPool2D layer</h3>

<p align="center"><img src="assets/1-globalmaxpooling2d-layer.png" alt="1 - GlobalMaxPooling2D layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [channels = 7, rows = 5, cols = 3].<br/>Then we add to the graph the GlobalMaxPool2D layer.</p>
...
<h3>GlobalMaxPool2D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-globalmaxpooling2d-batch-and-dimension.png" alt="2 - GlobalMaxPooling2D batch and dimension" width="260" /></p>
