...
<p>Setup and add the attention layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/86/863b0c26366c-attention_add_to_graph.png" alt="Attention_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="/_assets/shared-images/55/555871439695-param_attention.png" alt="param_attention" width="79" /></p></td>
    </tr>
  </tbody>
</table>
...
<h3>Attention layer with two identical input layer shape</h3>

<p align="center"><img src="assets/1-attention-with-two-identical-input-layer-shape.png" alt="1 - Attention with two identical input layer shape" width="260" /></p>
...
<p>We first define two input layers named “query_input” and “value_input”. This layers is setup as an input array shaped [Tq = 7, dim = 10] and [Tv = 7, dim = 10].<br/>Finally, we construct an array of the two graphs generated at the input of Attention.</p>
...
<h3>Attention layer with two different input layer shape</h3>

<p align="center"><img src="assets/2-attention-with-two-different-input-layer-shape.png" alt="2 - Attention with two different input layer shape" width="260" /></p>
...
<p>We first define two input layers named “query_input” and “value_input”. This layers is setup as an input array shaped [Tq = 4, dim = 10] and [Tv = 7, dim = 10].<br/>Finally, we construct an array of the two graphs generated at the input of Attention.</p>
