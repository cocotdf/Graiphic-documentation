<h1>GlobalMaxPool3D</h1>

<h2>Description</h2>

<p>Setup and add the global max pooling 3D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/02/0295e54527eb-global_max_pool_3d_add_to_graph.png" alt="Global_Max_Pool_3D_Add_To_Graph.Png" width="265" /></p>
...
<h3>GlobalMaxPool3D layer</h3>

<p align="center"><img src="assets/1-globalmaxpooling3d-layer-1.png" alt="1 - GlobalMaxPooling3D layer" width="260" /></p>
...
<p>First we define the first layer of the graph which is an Input Layer (explicit input layer method). This Input Layer is setup as an input array shaped [channels = 7, spatial_dim1 = 5, spatial_dim2 = 5, spatial_dim3 = 3].<br/>Then we “add to graph” GlobalMaxPool3D layer.</p>
...
<h3>GlobalMaxPool3D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-globalmaxpooling3d-batch-and-dimension.png" alt="2 - GlobalMaxPooling3D batch and dimension" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [channels = 7, spatial_dim1 = 5, spatial_dim2 = 5, spatial_dim3 = 3].<br/>Then we add to the graph the GlobalMaxPool3D layer.</p>
