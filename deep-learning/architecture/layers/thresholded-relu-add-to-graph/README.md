<h1>ThresholdedReLU</h1>

<h2>Description</h2>

<p>Setup and add thresholded relu layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/1b/1b3d55947138-thresholded_relu_add_to_graph.png" alt="Thresholded_Relu_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>theta : <em>float &gt;= 0</em></strong>, threshold location of activation.</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
      <td valign="top">Default value “1.0”.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="/_assets/shared-images/ed/ed03524cb147-param_define_with_theta.png" alt="param_define_with_theta" width="79" /></p></td>
    </tr>
  </tbody>
</table>
...
<h3>ThresholdedReLU layer</h3>

<p align="center"><img src="assets/1-thresholdedrelu-layer.png" alt="1 - ThresholdedReLU layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the ThresholdedReLU layer.</p>
...
<h3>ThresholdedReLU layer, batch and dimension</h3>

<p align="center"><img src="assets/2-thresholdedrelu-layer-batch-and-dimension.png" alt="2 - ThresholdedReLU layer batch and dimension" width="260" /></p>
