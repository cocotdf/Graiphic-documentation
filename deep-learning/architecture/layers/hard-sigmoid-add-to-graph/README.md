...
<p>Setup and add hard sigmoid layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/24/24b9c1b21993-hard_sigmoid_add_to_graph.png" alt="Hard_Sigmoid_Add_To_Graph.Png" width="265" /></p>
...
<h3>HardSigmoid layer</h3>

<p align="center"><img src="assets/1-hardsigmoid-layer.png" alt="1 - HardSigmoid layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the HardSigmoid layer.</p>
...
<h3>HardSigmoid layer, batch and dimension</h3>

<p align="center"><img src="assets/2-hardsigmoid-layer-batch-and-dimension.png" alt="2 - HardSigmoid layer batch and dimension" width="260" /></p>
