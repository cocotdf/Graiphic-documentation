...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>alpha : <em>float</em></strong>, slope of negative section. <strong>alpha </strong>controls the value to which an ELU saturates for negative net inputs.</td>
    </tr>
    <tr>
...
<p align="center"><img src="assets/1-elu-layer.png" alt="1 - ELU layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the ELU layer.</p>
...
<h3>ELU layer, batch and dimension</h3>

<p align="center"><img src="assets/2-elu-layer-batch-and-dimension.png" alt="2 - ELU layer batch and dimension" width="260" /></p>
