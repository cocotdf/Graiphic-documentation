...
<p>Setup and add the up sampling 1D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/02/02a6b217596c-up_sampling_1d_add_to_graph.png" alt="Up_Sampling_1D_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>size : <em>array integers</em></strong>, upsampling factor.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="assets/param_upsampling_1d.png" alt="param_upsampling_1d" width="106" /></p></td>
    </tr>
  </tbody>
</table>
...
<ul>
<li>If data_format = ‘channels_last’ : 3D tensor with shape (batch_size, upsampled_steps, features).</li>
<li>If data_format = ‘channels_first’ : 3D tensor with shape (batch_size, features, upsampled_steps).</li>
</ul>
...
<h3>UpSampling1D layer</h3>

<p align="center"><img src="assets/1-upsampling1d-layer.png" alt="1 - UpSampling1D layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [features = 7, steps = 5].<br/>Then we add to the graph the UpSampling1D layer.</p>

<p>3 – Run graph</p>

<p>We call the forward method and retrieve the result with the “Prediction 3D” method.<br/>This method returns two variables, the first one is the layer information (cluster composed of the layer name, the graph index and the shape of the output layer) and the second one is the prediction with a shape of [batch_size, features, upsampled_steps].</p>

<h3>UpSampling1D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-upsampling1d-batch-and-dimension.png" alt="2 - Upsampling1D batch and dimension" width="260" /></p>
