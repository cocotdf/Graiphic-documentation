...
<p>Setup and add relu layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>
...
<p align="center"><img src="assets/1-relu-layer.png" alt="1 - ReLU layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the ReLU layer.</p>
...
<h3>ReLU layer, batch and dimension</h3>

<p align="center"><img src="assets/2-relu-layer-batch-and-dimension.png" alt="2 - ReLU layer batch and dimension" width="260" /></p>
