...
<p align="center"><img src="/_assets/shared-images/2a/2a42a8f34dff-tanh_add_to_graph.png" alt="Tanh_Add_To_Graph.Png" width="265" /></p>
...
<p align="center"><img src="assets/1-tanh-layer.png" alt="1 - TanH layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the TanH layer.</p>
...
<h3>TanH layer, batch and dimension</h3>

<p align="center"><img src="assets/2-tanh-layer-batch-and-dimension.png" alt="2 - TanH layer batch and dimension" width="260" /></p>
