<h1>GlobalAvgPool2D</h1>

<h2>Description</h2>

<p>Setup and add the global average pooling 2D layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="/_assets/shared-images/5b/5b169e36dcdd-global_avg_pool.png" alt="global_avg_pool" width="106" /></p></td>
    </tr>
  </tbody>
</table>
...
<li>If keepdims = ‘True’ :
<ul>
<li>If data_format = ‘channels_last’ : 4D tensor with shape (batch_size, 1, 1, channels).</li>
<li>If data_format = ‘channels_first’ : 4D tensor with shape (batch_size, channels, 1, 1).</li>
</ul>
</li>
</ul>
...
<h3>GlobalAvgPool2D layer</h3>

<p align="center"><img src="assets/1-globalaveragepooling2d-layer.png" alt="1 - GlobalAveragePooling2D layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [channels = 7, rows = 5, cols = 3].<br/>Then we add to the graph the GlobalAvgPool2D layer.</p>
...
<h3>GlobalAvgPool2D layer, batch and dimension</h3>

<p align="center"><img src="assets/2-globalaveragepooling2d-batch-and-dimension.png" alt="2 - GlobalAveragePooling2D batch and dimension" width="260" /></p>
