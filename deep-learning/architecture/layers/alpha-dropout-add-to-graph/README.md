...
<p>Setup and add the alpha dropout layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>rate :</strong> <em><strong>float</strong></em>, drop probability (as with <strong>Dropout</strong>). The multiplicative noise will have standard <strong>deviation sqrt(rate / (1 – rate)).</strong></td>
    </tr>
    <tr>
...
<h3>AlphaDropout layer with explicit input layer</h3>

<p align="center"><img src="assets/1-alphadropout-layer.png" alt="1 - AlphaDropout layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [input_dim = 5].<br/>Then we add to the graph the AlphaDropout layer.</p>
...
<h3>AlphaDropout layer, batch and dimension</h3>

<p align="center"><img src="assets/2-alphadropout-batch-and-dimension.png" alt="2 - AlphaDropout batch and dimension" width="260" /></p>
