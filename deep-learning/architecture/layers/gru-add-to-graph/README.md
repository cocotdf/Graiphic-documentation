...
<p>Setup and add the gru layer into the model during the definition graph step. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/4c/4ce20571152f-gru_add_to_graph.png" alt="Gru_Add_To_Graph.Png" width="265" /></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="25%"><p align="center"><img src="assets/param_gru.png" alt="param_gru" width="192" /></p></td>
    </tr>
  </tbody>
</table>
...
<p align="center"><img src="assets/1-gru-layer.png" alt="1 - GRU layer" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [timesteps = 7, features = 5].<br/>Then we add to the graph the GRU layer.</p>
...
<h3>GRU layer, batch and dimension</h3>

<p align="center"><img src="assets/2-gru-batch-and-dimension.png" alt="2 - GRU batch and dimension" width="260" /></p>
...
<p>First, we define the first layer of the graph which is an Input layer (explicit input layer method). This layer is setup as an input array shaped [timesteps = 7, features = 3].<br/>Then we add to the graph the GRU layer.</p>
