...
<p>Calculates the natural log of the given input tensor, element-wise.</p>

<p align="center"><img alt="node_log.png" src="/_assets/shared-images/5d/5d5a0ed0ea6d-node_log.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the natural log of the input tensor computed element-wise.</td>
    </tr>
  </tbody>
</table>
