...
<p>Calculates the cosine of the given input tensor, element-wise.</p>

<p align="center"><img alt="node_cos.png" src="/_assets/shared-images/e3/e38632c41d16-node_cos.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the cosine of the input tensor computed element-wise.</td>
    </tr>
  </tbody>
</table>
