<h1>OptionalHasElement</h1>

<h2>Description</h2>

<p>Returns true if (1) the input is an optional-type and contains an element, or, (2) the input is a tensor or sequence type. If the input is not provided or is an empty optional-type, this op returns false.</p>

<p align="center"><img alt="node_optional_get_element.png" src="/_assets/shared-images/a1/a14695e85c7f-node_optional_get_element.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – B : <em>object, </em></strong>a scalar boolean tensor. If true, it indicates that optional-type input contains an element. Otherwise, it is empty.</td>
    </tr>
  </tbody>
</table>
...
<p><strong>B</strong> in (<code>tensor(bool)</code>) : Constrain output to a boolean tensor.</p>
