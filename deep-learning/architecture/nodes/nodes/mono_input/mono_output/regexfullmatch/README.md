...
<p align="center"><img alt="node_regex_full_match.png" src="/_assets/shared-images/a8/a8168d49a96b-node_regex_full_match.png" width="299"/></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_regex_full_match" src="assets/param_node_regex_full_match.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T1</strong> in (<code>tensor(string)</code>) : Inputs must be UTF-8 strings</p>

<p><strong>T2</strong> in (<code>tensor(bool)</code>) : Outputs are bools and are True where there is a full regex match and False otherwise.</p>
