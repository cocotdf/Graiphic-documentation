...
<p align="center"><img alt="node_hard_max.png" src="/_assets/shared-images/d6/d65a0b93748e-node_hard_max.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>axis : <em>integer,</em></strong> describes the dimension Hardmax will be performed on. Negative value means counting dimensions from the back. Accepted range is [-r, r-1] where r = rank(input).</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_hard_max" src="assets/param_node_hard_max.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
