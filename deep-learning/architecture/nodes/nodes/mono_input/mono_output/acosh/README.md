...
<p align="center"><img alt="node_acosh.png" src="/_assets/shared-images/41/41431b43b7e4-node_acosh.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the hyperbolic arccosine values of the input tensor computed element-wise.</td>
    </tr>
  </tbody>
</table>
