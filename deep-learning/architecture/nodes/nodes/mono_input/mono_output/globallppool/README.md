...
<p>GlobalLpPool consumes an input tensor X and applies lp pool pooling across the values in the same channel. This is equivalent to LpPool with kernel size equal to the spatial dimension of input tensor.</p>

<p align="center"><img alt="node_global_average_pool.png" src="/_assets/shared-images/d1/d1e84e919994-node_global_average_pool.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>p : <em>integer,</em></strong> p value of the Lp norm used to pool over the input data.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="node_global_lp_pool" src="assets/node_global_lp_pool.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Y (heterogeneous) – T : <em>object, </em></strong>output data tensor from pooling across the input tensor. The output tensor has the same rank as the input. The first two dimensions of output shape are the same as the input (N x C), while the other dimensions are all 1.</td>
    </tr>
  </tbody>
</table>
