...
<p>Calculates the tangent of the given input tensor, element-wise.</p>

<p align="center"><img alt="node_tan.png" src="/_assets/shared-images/d7/d74148d92d84-node_tan.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the tangent of the input tensor computed element-wise.</td>
    </tr>
  </tbody>
</table>
