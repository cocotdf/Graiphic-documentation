...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="detect_negative" src="assets/ccclst.png" width="42"/></td>
      <td valign="top"><strong>detect_negative : <em>cluster</em></strong>
<ul>
  <li><img alt="value" src="assets/cbool.png" width="32"/> <strong>value : <em>boolean</em></strong></li>
  <li><img alt="use_it" src="assets/cbool.png" width="32"/> <strong>use_it : <em>boolean</em></strong></li>
</ul></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="detect_positive" src="assets/ccclst.png" width="42"/></td>
