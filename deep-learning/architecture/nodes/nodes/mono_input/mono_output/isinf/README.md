...
<p>Setup and add IsInf node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/isinf.png" alt="IsInf" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="detect_negative" src="/_assets/shared-images/1a/1a7a9a6249a8-ccclst.png" width="42"/></td>
      <td valign="top"><strong>detect_negative : <em>cluster</em></strong>
<ul>
  <li><img alt="value" src="/_assets/shared-images/06/06612771a6c0-cbool.png" width="32"/> <strong>value : <em>boolean</em></strong></li>
  <li><img alt="use_it" src="/_assets/shared-images/06/06612771a6c0-cbool.png" width="32"/> <strong>use_it : <em>boolean</em></strong></li>
</ul></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="detect_positive" src="/_assets/shared-images/1a/1a7a9a6249a8-ccclst.png" width="42"/></td>
      <td valign="top"><strong>detect_positive : <em>cluster</em></strong>
<ul>
  <li><img alt="value" src="/_assets/shared-images/06/06612771a6c0-cbool.png" width="32"/> <strong>value : <em>boolean</em></strong></li>
  <li><img alt="use_it" src="/_assets/shared-images/06/06612771a6c0-cbool.png" width="32"/> <strong>use_it : <em>boolean</em></strong></li>
</ul></td>
