...
<p align="center"><img alt="node_not.png" src="/_assets/shared-images/8d/8daab6117856-node_not.png" width="299"/></p>
...
<p><strong>T</strong> in (<code>tensor(bool)</code>) : Constrain input/output to boolean tensors.</p>
