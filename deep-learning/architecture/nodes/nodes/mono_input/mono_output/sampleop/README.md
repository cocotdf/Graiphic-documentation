...
<p align="center"><img alt="node_sample_op.png" src="/_assets/shared-images/31/3177bc750dfe-node_sample_op.png" width="299"/></p>
...
<p><strong>T</strong> in (<code>tensor(uint32)</code>, <code>tensor(uint64)</code>, <code>tensor(int32)</code>, <code>tensor(int64)</code>, <code>tensor(float16)</code>, <code>tensor(float)</code>, <code>tensor(double)</code>) : Constrain to any tensor type. If the dtype attribute is not provided this must be a valid output type.</p>
