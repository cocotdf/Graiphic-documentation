...
<p align="center"><img alt="node_inverse.png" src="/_assets/shared-images/9a/9aeaeb4c7d43-node_inverse.png" width="299"/></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>X (heterogeneous) – T : <em>object, </em></strong>input tensor. Every matrix in the batch must be invertible.</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Y (heterogeneous) – T : <em>object, </em></strong>output tensor of the same type and shape as the input tensor.</td>
    </tr>
  </tbody>
</table>
