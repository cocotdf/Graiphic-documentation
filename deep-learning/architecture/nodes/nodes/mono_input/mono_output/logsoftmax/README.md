...
<p align="center"><img alt="node_log_softmax.png" src="/_assets/shared-images/7b/7b6cf9d89a35-node_log_softmax.png" width="299"/></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>input (heterogeneous) – T : <em>object, </em></strong>the input tensor of rank >= axis.</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>axis : <em>integer,</em></strong> describes the dimension LogSoftmax will be performed on. Negative value means counting dimensions from the back. Accepted range is [-r, r-1] where r = rank(input).</td>
    </tr>
    <tr>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the output values with the same shape as the input tensor.</td>
    </tr>
  </tbody>
</table>
