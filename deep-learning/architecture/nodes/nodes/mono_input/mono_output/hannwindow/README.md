...
<p align="center"><img alt="node_hann_window.png" src="/_assets/shared-images/d4/d4a1ab9e027f-node_hann_window.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T2 : <em>object, </em></strong>a Hann window with length: size. The output has the shape: .</td>
    </tr>
  </tbody>
</table>
