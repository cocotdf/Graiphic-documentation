...
<p>Calculates the hyperbolic cosine of the given input tensor element-wise.</p>

<p align="center"><img alt="node_cosh.png" src="/_assets/shared-images/fc/fcf4facff1c4-node_cosh.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the hyperbolic cosine values of the input tensor computed element-wise.</td>
    </tr>
  </tbody>
</table>
