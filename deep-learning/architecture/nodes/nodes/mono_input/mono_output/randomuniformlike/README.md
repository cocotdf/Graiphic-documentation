<h1>RandomUniformLike</h1>

<h2>Description</h2>

<p>Generate a tensor with random values drawn from a uniform distribution. The shape of the output tensor is copied from the shape of the input tensor, and the parameters of the uniform distribution are specified by <code>low</code> and <code>high</code>. The data type is specified by the ‘dtype’ argument, or copied from the input tensor if not provided. The ‘dtype’ argument must be one of the data types specified in the ‘DataType’ enum field in the TensorProto message and be valid as an output type.</p>

<p align="center"><img alt="node_random_normal_like.png" src="/_assets/shared-images/44/443740a24d4d-node_random_normal_like.png" width="299"/></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_random_uniform_like" src="assets/param_random_uniform_like.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output</strong> <strong>(heterogeneous) –</strong> <strong>T2</strong><strong> : <em>object, </em></strong>output tensor of random values drawn from uniform distribution.</td>
    </tr>
  </tbody>
</table>
