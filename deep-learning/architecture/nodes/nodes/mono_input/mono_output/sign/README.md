...
<p align="center"><img alt="node_sign.png" src="/_assets/shared-images/7c/7c08e1c224c9-node_sign.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the sign of the input tensor computed element-wise. It has the same shape and type of the input.</td>
    </tr>
  </tbody>
</table>
