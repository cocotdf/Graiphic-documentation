...
<p align="center"><img alt="node_bitwise_not.png" src="/_assets/shared-images/5c/5cfb521e7775-node_bitwise_not.png" width="299"/></p>
...
<p><strong>T</strong> in (<code>tensor(int16)</code>, <code>tensor(int32)</code>, <code>tensor(int64)</code>, <code>tensor(int8)</code>, <code>tensor(uint16)</code>, <code>tensor(uint32)</code>, <code>tensor(uint64)</code>, <code>tensor(uint8)</code>) : Constrain input/output to integer tensors.</p>
