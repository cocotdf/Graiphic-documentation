...
<p>Setup and add IsNaN node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/isnan.png" alt="IsNaN" width="270" /></p>
