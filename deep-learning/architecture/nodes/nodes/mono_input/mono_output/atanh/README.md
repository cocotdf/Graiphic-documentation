...
<p>Calculates the hyperbolic arctangent of the given input tensor element-wise.</p>

<p align="center"><img alt="node_atanh.png" src="/_assets/shared-images/43/43610a895f60-node_atanh.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the hyperbolic arctangent values of the input tensor computed element-wise.</td>
    </tr>
  </tbody>
</table>
