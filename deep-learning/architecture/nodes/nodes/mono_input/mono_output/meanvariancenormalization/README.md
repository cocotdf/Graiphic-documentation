<h1>MeanVarianceNormalization</h1>
...
<p align="center"><img alt="node_mean_variance_norm.png" src="/_assets/shared-images/93/93bf7f34c605-node_mean_variance_norm.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>axes : <em>array,</em></strong> a list of integers, along which to reduce. The default is to calculate along axes [0,2,3] for calculating mean and variance along each channel. Two variables with the same C-coordinate are associated with the same mean and variance.</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
      <td valign="top">Default value “[0, 2, 3]”.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_mean_variance_norm" src="assets/param_node_mean_variance_norm.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(bfloat16)</code>, <code>tensor(double)</code>, <code>tensor(float)</code>, <code>tensor(float16)</code>) : Constrain input and output types to all numeric tensors.</p>
