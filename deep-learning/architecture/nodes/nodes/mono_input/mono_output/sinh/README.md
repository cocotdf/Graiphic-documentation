...
<p align="center"><img alt="node_sinh.png" src="/_assets/shared-images/2f/2f5b0d4a0c7e-node_sinh.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the hyperbolic sine values of the input tensor computed element-wise.</td>
    </tr>
  </tbody>
</table>
