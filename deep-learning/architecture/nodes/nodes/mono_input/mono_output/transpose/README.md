...
<p align="center"><img alt="node_transpose.png" src="/_assets/shared-images/f1/f1c40750f180-node_transpose.png" width="311"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>perm : <em>array,</em></strong> a list of integers. By default, reverse the dimensions, otherwise permute the axes according to the values given.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_transpose" src="assets/param_node_transpose.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>transposed (heterogeneous) – T : <em>object, </em></strong>transposed output.</td>
    </tr>
  </tbody>
</table>
