...
<p align="center"><img alt="node_erf.png" src="/_assets/shared-images/4a/4a088403667a-node_erf.png" width="299"/></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the error function of the input tensor computed element-wise. It has the same shape and type of the input.</td>
    </tr>
  </tbody>
</table>
