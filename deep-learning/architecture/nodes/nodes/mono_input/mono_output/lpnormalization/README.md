<h1>LpNormalization</h1>

<h2>Description</h2>

<p>Given a matrix, apply Lp-normalization along the provided axis.</p>

<p align="center"><img alt="node_lp_norm.png" src="/_assets/shared-images/ec/ecd0ed837445-node_lp_norm.png" width="299"/></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>input (heterogeneous) – T : <em>object, </em></strong>input matrix.</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>axis : <em>integer,</em></strong> the axis on which to apply normalization, -1 mean last axis.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Integer 32.Png" src="/_assets/shared-images/6c/6c9e54b4bc43-integer-32.png" width="42"/></td>
      <td valign="top"><strong>p : <em>integer,</em></strong> the order of the normalization, only 1 or 2 are supported.</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_lp_norm" src="assets/param_node_lp_norm.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>matrix after normalization.</td>
    </tr>
  </tbody>
</table>
