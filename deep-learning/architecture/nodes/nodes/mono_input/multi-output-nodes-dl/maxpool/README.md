...
<p align="center"><img alt="node_max_pool.png" src="/_assets/shared-images/21/2119c095c4d1-node_max_pool.png" width="311"/></p>
...
<p>The output of each pooling window is maximum number of elements exclude pad.</p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_max_pool" src="assets/param_node_max_pool.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Output_Object_3.Png" src="/_assets/shared-images/e2/e2d605658777-output_object_3.png" width="42"/></td>
      <td valign="top"><strong>Indices (optional, heterogeneous) – I : <em>object, </em></strong>indices tensor from max pooling across the input tensor. The dimensions of indices are the same as output tensor. The values in indices of are the indices of the selected values during pooling. The indices are computed as flatten 1-D tensor, and the indices do not consider padding. So the values in indices are in [0, N x C x D1 x … x Dn).</td>
    </tr>
  </tbody>
</table></td>
      <td valign="top" width="30%"><p align="center"><img alt="output_node_max_pool" src="assets/output_node_max_pool.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(double)</code>, <code>tensor(float)</code>, <code>tensor(float16)</code>, <code>tensor(int8)</code>, <code>tensor(uint8)</code>) : Constrain input and output types to float and 8 bit tensors.</p>
