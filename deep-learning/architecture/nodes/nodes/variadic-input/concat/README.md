...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="node_concat.png" src="/_assets/shared-images/6d/6d94c4fe8340-node_concat.png" width="42"/></td>
      <td valign="top"><strong>inputs (variadic, heterogeneous) – T : <em>array, </em></strong>list of tensors for concatenation.</td>
    </tr>
  </tbody>
</table>
