...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>data_0 (variadic, heterogeneous)  – T : <em>array, </em></strong>list of tensors for max.</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>max (heterogeneous) – T : <em>object, </em></strong>output tensor.</td>
    </tr>
  </tbody>
</table>
