...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>data_0 (variadic, heterogeneous)  – T : <em>array, </em></strong>list of tensors for sum.</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>sum (heterogeneous) – T : <em>object, </em></strong>output tensor.</td>
    </tr>
  </tbody>
</table>
