...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="input_array_object_3.png" src="/_assets/shared-images/95/958d2691cfbc-input_array_object_3.png" width="42"/></td>
      <td valign="top"><strong>data_0 (variadic, heterogeneous)  – T : <em>array, </em></strong>list of tensors for min.</td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>min (heterogeneous) – T : <em>object, </em></strong>output tensor.</td>
    </tr>
  </tbody>
</table>
