...
<p>Relu takes one input data (Tensor) and produces one output data (Tensor) where the rectified linear function, y = max(0, x), is applied to the tensor elementwise.</p>

<p align="center"><img src="/_assets/shared-images/fc/fc8fd7b8108b-node_relu.png" alt="Node_Relu.Png" width="299" /></p>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="Cluster.Png" src="../../../../../../_resolved/and/assets/cluster.png" width="32"/><strong>Parameters : <em>cluster,</em></strong></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/ae/ae1b228c43e4-layer_param.png" alt="layer_param" width="79" /></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(bfloat16)</code>, <code>tensor(double)</code>, <code>tensor(float)</code>, <code>tensor(float16)</code>, <code>tensor(int16)</code>, <code>tensor(int32)</code>, <code>tensor(int64)</code>, <br/><code>tensor(int8)</code>) : Constrain input and output types to signed numeric tensors.</p>
