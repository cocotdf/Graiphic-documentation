...
<p>The operator computes the normalized exponential values for the given input : Softmax(input, axis) = Exp(input) / ReduceSum(Exp(input), axis=axis, keepdims=1)<br/>The “axis” attribute indicates the dimension along which Softmax will be performed. The output tensor has the same shape and contains the Softmax values of the corresponding input.</p>

<p align="center"><img alt="SoftMax" src="assets/SoftMax.png" width="299"/></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>input</strong> <strong>(heterogeneous) – T : <em>object, </em></strong>the input tensor of rank >= axis.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>axis : <em>integer,</em></strong> describes the dimension Softmax will be performed on. Negative value means counting dimensions from the back. Accepted range is [-r, r-1] where r = rank(input).</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/f6/f6337ccded4a-param_concatenate.png" alt="param_node_softmax" width="79" /></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output</strong><strong> (heterogeneous) – T : <em>object, </em></strong>the output values with the same shape as the input tensor.</td>
    </tr>
  </tbody>
</table>
