...
<p align="center"><img src="/_assets/shared-images/f9/f9c4b6587837-node_softsign.png" alt="Node_Softsign.Png" width="299" /></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>the softsign (x/(1+|x|)) values of the input tensor computed element-wise.</td>
    </tr>
  </tbody>
</table>
