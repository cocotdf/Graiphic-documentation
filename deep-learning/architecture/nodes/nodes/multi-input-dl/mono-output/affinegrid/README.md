...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="theta" src="assets/cONNXModellvclass.png" width="42"/></td>
      <td valign="top"><strong>theta : <em>class</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="size" src="assets/cONNXModellvclass.png" width="42"/></td>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="align_corners" src="assets/cbool.png" width="42"/></td>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="grid" src="assets/iONNXModellvclass.png" width="42"/></td>
