...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_mul_integer" src="assets/input_node_mul_integer.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(uint8)</code>, <code>tensor(int8)</code>) : Constrain input types to 8 bit signed and unsigned tensors. </p>

<p><strong>T1</strong> in (<code>tensor(int32)</code>) : Constrain output types to 32 bit tensors.</p>
