...
<p>Setup and add Gemm node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/gemm.png" alt="Gemm" width="270" /></p>
