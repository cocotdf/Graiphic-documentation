...
<p align="center"><img alt="node_string_concat.png" src="/_assets/shared-images/db/dba1af01acb2-node_string_concat.png" width="299"/></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>A (heterogeneous) – T : <em>object, </em></strong>tensor to prepend in concatenation.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>B (heterogeneous) – T : <em>object, </em></strong>tensor to append in concatenation.</td>
    </tr>
  </tbody>
</table></td>
    </tr>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Z (heterogeneous) – T : <em>object, </em></strong>concatenated string tensor.</td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(string)</code>) : Inputs and outputs must be UTF-8 strings.</p>
