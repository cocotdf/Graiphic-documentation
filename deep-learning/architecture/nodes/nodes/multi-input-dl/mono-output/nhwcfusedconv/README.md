...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>Z (optional, heterogeneous) – T : <em>object, </em></strong>tensor to be added to the output, must be the same shape and format as the output tensor.</td>
    </tr>
  </tbody>
</table></td>
    </tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_fused_conv" src="assets/input_node_fused_conv.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>activation : <em>enum, </em></strong>defines the type of activation to be applied immediately after the convolution.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top"><strong>activation_params : <em>array, </em></strong>contains the parameters associated with the chosen activation.</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
    ...
    <tr>
      <td width="64" valign="top"><img alt="node_nhwc_fused_conv.png" src="/_assets/shared-images/3e/3e1483d4920d-node_nhwc_fused_conv.png" width="42"/></td>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_fused_conv" src="assets/param_node_fused_conv.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(float16)</code>) : Constrain input and output types to float tensors.</p>
