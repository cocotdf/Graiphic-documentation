...
<p>Setup and add Compress node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/compress.png" alt="Compress" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="condition" src="assets/cONNXModellvclass.png" width="42"/></td>
      <td valign="top"><strong>condition : <em>class</em></strong></td>
    </tr>
  </tbody>
</table>
      </td>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="axis" src="assets/ccclst.png" width="42"/></td>
      <td valign="top"><strong>axis : <em>cluster</em></strong>
<ul>
  <li><img alt="value" src="assets/ci32.png" width="32"/> <strong>value : <em>integer</em></strong></li>
