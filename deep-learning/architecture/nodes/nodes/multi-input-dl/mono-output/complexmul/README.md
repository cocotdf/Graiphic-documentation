...
<p>Setup and add ComplexMul node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/complexmul.png" alt="ComplexMul" width="270" /></p>
