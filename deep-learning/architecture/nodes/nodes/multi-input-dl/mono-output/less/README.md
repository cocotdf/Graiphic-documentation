...
<p>Returns the tensor resulted from performing the <code>less</code> logical operation elementwise on the input tensors <code>A</code> and <code>B</code> (with Numpy-style broadcasting support). This operator supports <strong>multidirectional (i.e., Numpy-style) broadcasting</strong>; for more details please check <a href="https://github.com/onnx/onnx/blob/main/docs/Broadcasting.md">Broadcasting in ONNX</a>.</p>

<p align="center"><img alt="node_less.png" src="/_assets/shared-images/ba/ba993614d05f-node_less.png" width="299"/></p>
