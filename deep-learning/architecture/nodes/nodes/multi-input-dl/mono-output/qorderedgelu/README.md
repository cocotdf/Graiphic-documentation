...
<p align="center"><img alt="node_q_ordered_gelu.png" src="/_assets/shared-images/bd/bdf4068d39c8-node_q_ordered_gelu.png" width="299"/></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>X (heterogeneous) – Q : <em>object, </em></strong>N-dimensional input A.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>scale_X (heterogeneous) – S : <em>object, </em></strong>scale of the input A.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>scale_Y </strong><strong>(heterogeneous) – S : <em>object, </em></strong>3D scale of the output Y.</td>
    </tr>
  </tbody>
</table></td>
    </tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_q_ordered_gelu" src="assets/input_node_q_ordered_gelu.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_q_ordered_gelu" src="assets/param_node_q_ordered_gelu.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Y (heterogeneous) – Q : <em>object, </em></strong>output of the Gelu.</td>
    </tr>
  </tbody>
</table>
...
<p><b>S </b>in (<code>tensor(float)</code>) : Constrain scales to float32.</p>
