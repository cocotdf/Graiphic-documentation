...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_n_gram_repeat_block" src="assets/input_node_n_gram_repeat_block.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="node_n_gram_repeat_block.png" src="/_assets/shared-images/21/21289df866ea-node_n_gram_repeat_block.png" width="42"/></td>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_n_gram_repeat_block" src="assets/param_node_n_gram_repeat_block.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(int64)</code>) : Constrain indices to integer types.</p>

<p><strong>Tid</strong> in (<code>tensor(float)</code>) : Constrain scores input and output types to float tensors.</p>
