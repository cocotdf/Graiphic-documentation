...
<p align="center"><img alt="node_q_linear_softmax.png" src="/_assets/shared-images/61/6113fbac5a67-node_q_linear_softmax.png" width="299"/></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>X_scale (heterogeneous) – tensor(float) : <em>object, </em></strong>scale of quantized input ‘X’. It must be a scalar.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>X_zero_point (optional, heterogeneous) – T : <em>object, </em></strong>zero point tensor for input ‘X’.It must be a scalar.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>Y_scale (heterogeneous) – tensor(float) : <em>object, </em></strong>scale of quantized output ‘Y’. It must be a scalar.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>axis : <em>integer,</em></strong> apply softmax to elements for dimensions axis,or all dims along with axis according to op-version.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Input_Interger_64.Png" src="/_assets/shared-images/c9/c9a23cc7d835-input_interger_64.png" width="42"/></td>
      <td valign="top"><strong>opset : <em>integer,</em></strong> opset version of corresponding SoftMax.</td>
    </tr>
    <tr>
      <td width="64" valign="top"></td>
      <td valign="top">Default value “17”.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_q_linear_softmax" src="assets/param_node_q_linear_softmax.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Y (heterogeneous) – T :</strong> <em><strong>object,</strong></em> output data tensor from pooling across the input tensor. The output tensor has the same rank as the input.</td>
    </tr>
  </tbody>
</table>
