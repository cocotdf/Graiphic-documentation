<h1>DequantizeWithOrder</h1>

<h2>Description</h2>

<p>Setup and add DequantizeWithOrder node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/dequantizewithorder.png" alt="DequantizeWithOrder" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="scale_input" src="/_assets/shared-images/7b/7b301cd4aa9d-connxmodellvclass.png" width="42"/></td>
      <td valign="top"><strong>scale_input : <em>class</em></strong></td>
    </tr>
  </tbody>
</table>
      </td>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="order_input" src="/_assets/shared-images/7f/7f7e66ba54dc-cenum.png" width="42"/></td>
      <td valign="top"><strong>order_input : <em>enum</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="order_output" src="/_assets/shared-images/7f/7f7e66ba54dc-cenum.png" width="42"/></td>
      <td valign="top"><strong>order_output : <em>enum</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="to" src="/_assets/shared-images/d9/d9389531307d-cu16.png" width="42"/></td>
      <td valign="top"><strong>to : <em>integer</em></strong></td>
    </tr>
    <tr>
