...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="scale_input" src="assets/cONNXModellvclass.png" width="42"/></td>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="order_input" src="assets/cenum.png" width="42"/></td>
      <td valign="top"><strong>order_input : <em>enum</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="order_output" src="assets/cenum.png" width="42"/></td>
      <td valign="top"><strong>order_output : <em>enum</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="to" src="assets/cu16.png" width="42"/></td>
