...
<p>Setup and add BitShift node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/bitshift.png" alt="BitShift" width="270" /></p>
