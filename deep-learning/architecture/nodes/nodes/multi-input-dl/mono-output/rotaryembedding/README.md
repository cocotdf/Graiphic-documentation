...
<p align="center"><img alt="node_rotary_embedding.png" src="/_assets/shared-images/a3/a380cd178bc9-node_rotary_embedding.png" width="299"/></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_rotary_embedding" src="assets/input_node_rotary_embedding.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_rotary_embedding" src="assets/param_node_rotary_embedding.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(float)</code>, <code>tensor(float16)</code>, <code>tensor(bfloat16)</code>) : Constrain input and output types to float tensors.</p>

<p><strong>M</strong> in (<code>tensor(int64)</code>) : Constrain input and output types to integer tensors.</p>
