...
<p>Setup and add CDist node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/cdist.png" alt="CDist" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="metric" src="/_assets/shared-images/7f/7f7e66ba54dc-cenum.png" width="42"/></td>
      <td valign="top"><strong>metric : <em>enum</em></strong></td>
    </tr>
    <tr>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="C" src="/_assets/shared-images/1f/1f730a978528-ionnxmodellvclass.png" width="42"/></td>
