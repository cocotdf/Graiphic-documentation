...
<p align="center"><img alt="node_tile.png" src="/_assets/shared-images/87/870b8ebd5a67-node_tile.png" width="299"/></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>input (heterogeneous) –</strong> <strong>T :</strong> <em><strong>object,</strong></em> input tensor of any shape.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>repeats (heterogeneous) – T1 : <em>object, </em></strong>1D int64 tensor of the same length as input’s dimension number, includes numbers of repeated copies along input’s dimensions.</td>
    </tr>
  </tbody>
</table></td>
    </tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_tile" src="assets/input_node_tile.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T :</strong> <em><strong>object,</strong></em> output tensor of the same dimensions and type as tensor input. output_dim = input_dim * repeats.</td>
    </tr>
  </tbody>
</table>
...
<p><strong>T1</strong> in (<code>tensor(int64)</code>) : Constrain repeat’s type to int64 tensors.</p>
