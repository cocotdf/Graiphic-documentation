...
<p align="center"><img alt="node_q_linear_sigmoid.png" src="/_assets/shared-images/0b/0b4557b0a6c6-node_q_linear_sigmoid.png" width="299"/></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>X_scale (heterogeneous) – tensor(float) : <em>object, </em></strong>input X’s scale. It’s a scalar, which means a per-tensor/layer quantization.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>Y_scale (heterogeneous) – tensor(float) : <em>object, </em></strong>output Y’s scale. It’s a scalar, which means a per-tensor/layer quantization.</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_q_linear_sigmoid" src="/_assets/shared-images/21/21fa694d64bb-input_node_q_linear_sigmoid.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Y (heterogeneous) – T :</strong> <em><strong>object,</strong></em> output tensor.</td>
    </tr>
  </tbody>
</table>
