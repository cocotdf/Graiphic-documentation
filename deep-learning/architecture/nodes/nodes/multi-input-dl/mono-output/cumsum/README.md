...
<p>Setup and add CumSum node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/cumsum.png" alt="CumSum" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="exclusive" src="/_assets/shared-images/06/06612771a6c0-cbool.png" width="42"/></td>
      <td valign="top"><strong>exclusive : <em>boolean</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="reserve" src="/_assets/shared-images/06/06612771a6c0-cbool.png" width="42"/></td>
      <td valign="top"><strong>reserve : <em>boolean</em></strong></td>
    </tr>
    <tr>
