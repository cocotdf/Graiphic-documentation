...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_relative_position_bias" src="assets/input_node_relative_position_bias.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="node_relative_position_bias.png" src="/_assets/shared-images/25/25ccd831bdc1-node_relative_position_bias.png" width="42"/></td>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_relative_position_bias" src="assets/param_node_relative_position_bias.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(float)</code>, <code>tensor(float16)</code>) : Constrain input and output types to float or half tensors.</p>

<p><strong>U</strong> in (<code>tensor(int64)</code>) : Constrain sequence_length to int tensors.</p>
