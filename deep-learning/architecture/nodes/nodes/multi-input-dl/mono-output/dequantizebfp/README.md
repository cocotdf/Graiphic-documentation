...
<p>Setup and add DequantizeBFP node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/dequantizebfp.png" alt="DequantizeBFP" width="270" /></p>
