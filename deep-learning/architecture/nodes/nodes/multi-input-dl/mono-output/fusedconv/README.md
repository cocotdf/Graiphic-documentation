...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Z" src="/_assets/shared-images/7b/7b301cd4aa9d-connxmodellvclass.png" width="42"/></td>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="activation_params" src="/_assets/shared-images/e3/e3e937685614-c1dsgl.png" width="42"/></td>
      <td valign="top"><strong>activation_params : <em>array of float</em></strong>
<ul>
  <li><img alt="Numeric" src="/_assets/shared-images/8c/8c54522fc255-csgl.png" width="32"/> <strong>Numeric : <em>float</em></strong></li>
</ul></td>
    </tr>
    <tr>
