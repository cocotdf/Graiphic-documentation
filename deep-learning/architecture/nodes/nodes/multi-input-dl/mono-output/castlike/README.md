...
<p>Setup and add CastLike node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/castlike.png" alt="CastLike" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="target_type" src="/_assets/shared-images/7b/7b301cd4aa9d-connxmodellvclass.png" width="42"/></td>
      <td valign="top"><strong>target_type : <em>class</em></strong></td>
    </tr>
  </tbody>
</table>
      </td>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="saturate" src="/_assets/shared-images/06/06612771a6c0-cbool.png" width="42"/></td>
      <td valign="top"><strong>saturate : <em>boolean</em></strong></td>
    </tr>
    <tr>
