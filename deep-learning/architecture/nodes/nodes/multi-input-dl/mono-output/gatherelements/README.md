<h1>GatherElements</h1>

<h2>Description</h2>

<p>Setup and add GatherElements node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/gatherelements.png" alt="GatherElements" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="data" src="assets/cONNXModellvclass.png" width="42"/></td>
      <td valign="top"><strong>data : <em>class</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="indices" src="assets/cONNXModellvclass.png" width="42"/></td>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="axis" src="assets/ci32.png" width="42"/></td>
