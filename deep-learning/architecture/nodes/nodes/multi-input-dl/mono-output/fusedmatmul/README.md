...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="transBatchA" src="assets/cbool.png" width="42"/></td>
      <td valign="top"><strong>transBatchA : <em>boolean</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="transBatchB" src="assets/cbool.png" width="42"/></td>
