...
<p>Setup and add Clip node into the model during the definition graph step. Type : polymorphic.</p>
<p align="center"><img src="assets/clip.png" alt="Clip" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="min" src="/_assets/shared-images/7b/7b301cd4aa9d-connxmodellvclass.png" width="42"/></td>
      <td valign="top"><strong>min : <em>class</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="max" src="/_assets/shared-images/7b/7b301cd4aa9d-connxmodellvclass.png" width="42"/></td>
      <td valign="top"><strong>max : <em>class</em></strong></td>
    </tr>
  </tbody>
</table>
      </td>
