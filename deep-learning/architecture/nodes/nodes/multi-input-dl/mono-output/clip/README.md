...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="min" src="assets/cONNXModellvclass.png" width="42"/></td>
      <td valign="top"><strong>min : <em>class</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="max" src="assets/cONNXModellvclass.png" width="42"/></td>
