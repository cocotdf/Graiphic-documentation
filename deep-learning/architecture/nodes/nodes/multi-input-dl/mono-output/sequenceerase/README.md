...
<p align="center"><img alt="node_sequence_erase.png" src="/_assets/shared-images/26/2671964e0820-node_sequence_erase.png" width="344"/></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>position (optional, heterogeneous) – I : <em>object, </em></strong>position of the tensor in the sequence. Negative value means counting positions from the back. Accepted range in <code>[-n, n - 1]</code>, where <code>n</code> is the number of tensors in ‘input_sequence’. It is an error if any of the index values are out of bounds. It must be a scalar(tensor of empty shape).</td>
    </tr>
  </tbody>
</table></td>
    </tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_sequence_at" src="/_assets/shared-images/45/45e0fba89aa7-input_node_sequence_at.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output_sequence (heterogeneous) – S : <em>object, </em></strong>output sequence that has the tensor at the specified position removed.</td>
    </tr>
  </tbody>
</table>
