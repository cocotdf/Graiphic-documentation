...
<p align="center"><img alt="node_bitmask_bias_dropout.png" src="/_assets/shared-images/c3/c3d3843b6704-node_bitmask_bias_dropout.png" width="311"/></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Output_Object_3.Png" src="/_assets/shared-images/e2/e2d605658777-output_object_3.png" width="42"/></td>
      <td valign="top"><strong>mask – T3 : <em>object, </em></strong>the output mask of dropout.</td>
    </tr>
  </tbody>
</table></td>
    </tr>
...
<p><strong>T2</strong> in (<code>tensor(bool)</code>) : Constrain input ‘training_mode’ types to boolean tensors.</p>

<p><strong>T3</strong> in (<code>tensor(uint32)</code>) : Constrain output ‘mask’ types to uint32 tensors.</p>
