...
<p>GemmaRotaryEmbedding is the implementation of below part of rotary positional embeddings (RoPE). It implements below from modeling_gemma.py.</p>

<p align="center"><img alt="node_gemma_rotary_embedding.png" src="/_assets/shared-images/92/92b3a91709b2-node_gemma_rotary_embedding.png" width="311"/></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_gemma_rotary_embedding" src="assets/input_node_gemma_rotary_embedding.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="output_node_gemma_rotary_embedding" src="assets/output_node_gemma_rotary_embedding.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(float16)</code>) : Constrain input and output types to float16 tensors.</p>

<p><strong>U</strong> in (<code>tensor(float)</code>) : Constrain input 0 type to float tensors.</p>
