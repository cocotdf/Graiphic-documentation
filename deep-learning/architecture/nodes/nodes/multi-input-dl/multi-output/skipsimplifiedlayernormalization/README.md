<h1>SkipSimplifiedLayerNormalization</h1>

<h2>Description</h2>

<p>Skip and Root Mean Square Layer Normalization.</p>

<p align="center"><img alt="node_simplified_layer_norm.png" src="/_assets/shared-images/a9/a957fac680e4-node_simplified_layer_norm.png" width="311"/></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>input (heterogeneous) – T : <em>object, </em></strong>3D input tensor with shape (batch_size, sequence_length, hidden_size)Or 2D input tensor with shape (token_count, hidden_size).</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>skip (heterogeneous) – T : <em>object, </em></strong>3D input tensor with shape (batch_size, sequence_length, hidden_size)Or 2D input tensor with shape (token_count, hidden_size).</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_node_simplified_layer_norm" src="assets/input_node_simplified_layer_norm.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_skip_layer_norm" src="/_assets/shared-images/7f/7f35926ad4cf-param_node_skip_layer_norm.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output (heterogeneous) – T : <em>object, </em></strong>3D output tensor with shape (batch_size, sequence_length, hidden_size)Or 2D output tensor with shape (token_count, hidden_size).</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Output_Object_3.Png" src="/_assets/shared-images/e2/e2d605658777-output_object_3.png" width="42"/></td>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Output_Object_3.Png" src="/_assets/shared-images/e2/e2d605658777-output_object_3.png" width="42"/></td>
      <td valign="top"><strong>input_skip_bias_sum (optional, heterogeneous) – T : <em>object, </em></strong>sum of the input and skip inputs (and bias if it exists)with shape (batch_size, sequence_length, hidden_size) or (token_count, hidden_size).</td>
    </tr>
  </tbody>
</table></td>
    </tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="output_node_skip_layer_norm" src="/_assets/shared-images/ea/eac873f72f91-output_node_skip_layer_norm.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(bfloat16)</code>, <code>tensor(float16)</code>, <code>tensor(float)</code>) : Constrain input and output to float tensors.</p>
