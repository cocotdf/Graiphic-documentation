...
<p align="center"><img alt="node_prelu.png" src="/_assets/shared-images/6d/6de4eb3cf949-node_prelu.png" width="299"/></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="Input_Object_3.Png" src="/_assets/shared-images/1b/1bd436ec7533-input_object_3.png" width="42"/></td>
      <td valign="top"><strong>slope (heterogeneous) – T : <em>object, </em></strong>slope tensor. The shape of slope can be smaller than first input X; if so, its shape must be unidirectional broadcastable to X.</td>
    </tr>
  </tbody>
</table></td>
      <td valign="top" width="30%"><p align="center"><img alt="input_node_prelu" src="assets/input_node_prelu.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Y (heterogeneous) – T : <em>object, </em></strong>output tensor (same size as X).</td>
    </tr>
  </tbody>
</table>
...
<p><strong>T</strong> in (<code>tensor(bfloat16)</code>, <code>tensor(double)</code>, <code>tensor(float)</code>, <code>tensor(float16)</code>, <code>tensor(int32)</code>, <code>tensor(int64)</code>, <code>tensor(uint32)</code>,<br/><code>tensor(uint64)</code>) : Constrain input and output types to float/int tensors.</p>
