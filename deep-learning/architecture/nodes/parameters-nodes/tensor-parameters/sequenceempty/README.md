...
<p align="center"><img alt="node_sequence_empty.png" src="/_assets/shared-images/40/40c369d869ac-node_sequence_empty.png" width="299"/></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>dtype : <em>enum,</em></strong> the data type of the tensors in the output sequence.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_node_sequence_empty" src="assets/param_node_sequence_empty.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>output</strong> <strong>(heterogeneous) –</strong> <strong>S : <em>object, </em></strong>empty sequence.</td>
    </tr>
  </tbody>
</table>
...
<p><strong>S</strong> in (<code>seq(tensor(bool))</code>, <code>seq(tensor(complex128))</code>, <code>seq(tensor(complex64))</code>, <code>seq(tensor(double))</code>, <code>seq(tensor(float))</code>,<br/>
