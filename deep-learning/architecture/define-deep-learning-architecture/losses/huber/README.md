...
<p>Computes the Huber loss between y_true and y_pred.​ Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img alt="Huber" src="/_assets/shared-images/7c/7c67d9cdb274-binary-crossentropy.png" width="230"/></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>delta : <em>float, </em></strong>the point where the Huber loss function changes from a quadratic to linear.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="param_huber" src="assets/param_huber.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
