...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>min : <em>float,</em></strong> a scalar. Lower bound of the range of random values to generate (inclusive).</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Single.Png" src="/_assets/shared-images/e2/e22146c46f27-single.png" width="42"/></td>
      <td valign="top"><strong>max : <em>float,</em></strong> a scalar. Upper bound of the range of random values to generate (exclusive).</td>
    </tr>
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="random_uniform_param" src="assets/random_uniform_param.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
