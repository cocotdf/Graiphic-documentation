...
<p>Defines the weights of the SimpleRNN layer selected by the index. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/e4/e469fb7162c6-set_weights_simple_rnn_index.png" alt="Set_Weights_Simple_Rnn_Index.Png" width="279" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>simple_rnn_weight : <em>cluster</em></strong></td>
    </tr>
    <tr>
      <td></td>
      <td valign="top"><table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/97/97ffd1cf88be-weights_simple_rnn_cluster.png" alt="weights_simple_rnn_cluster" width="153" /></p></td>
    </tr>
  </tbody>
</table>
