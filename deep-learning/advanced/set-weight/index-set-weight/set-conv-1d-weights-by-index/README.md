...
<p>Defines the weights of the Conv1D layer selected by the index. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/81/8156f91b1265-set_weights_conv_1d_transpose_index.png" alt="Set_Weights_Conv_1D_Index.Png" width="228" /></p>
...
<p>The size of filters depends on the input of the <a href="../../../../architecture/layers/conv-1d-add-to-graph/README.md">Conv1D</a> layer and the parameters n_filters and size.<br/>For example, if the input of the layer has a size of [batch_size = 10, channel = 5, width = 2], n_filters has the value 6 and size the value 3 then filters will have a size of [n_filters = 6, channel = 5, size = 3].</p>
