...
<p>Defines the weights of the ConvLSTM2D layer selected by the index. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/cb/cbf5ab646f6b-set_weights_conv_lstm_2d_index.png" alt="Set_Weights_Conv_Lstm_2D_Index.Png" width="293" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>conv_lstm_2d_weight : <em>cluster</em></strong></td>
    </tr>
    <tr>
      <td></td>
      <td valign="top"><table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/e3/e3b9fe587134-weights_conv_lstm_2d_cluster.png" alt="weights_conv_lstm_2d_cluster" width="155" /></p></td>
    </tr>
  </tbody>
</table>
