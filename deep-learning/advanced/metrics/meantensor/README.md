...
<p>The MeanTensor function calculates the element-by-element average of two tensors with the same shape.</p>

<p align="center"><img alt="mean_tensor_calcul" src="assets/mean_tensor_calcul.png" width="220"/></p>
