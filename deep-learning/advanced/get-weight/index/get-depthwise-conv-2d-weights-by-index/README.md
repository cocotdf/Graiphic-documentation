...
<p>Gets the weights of the DepthwiseConv2D layer selected by the index. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>filters : <em>array, </em></strong>4D values. filters_depthwise = [channels, 1, size[0], size[1]].</td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="Array Single Out.Png" src="/_assets/shared-images/fd/fdf478605b09-array-single-out.png" width="42"/></td>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/67/67e356cd8016-depthwise_conv_2d_weights_info.png" alt="depthwise_conv_2d_weights_info" width="157" /></p></td>
    </tr>
  </tbody>
</table>
