...
<p>Gets the weights of the Dense layer selected by the index. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/24/24be04cdac43-dense_weights_info.png" alt="dense_weights_info" width="157" /></p></td>
    </tr>
  </tbody>
</table>
...
<p>The size of weights depends on the input of the <a href="../../../../architecture/layers/dense-add-to-graph/README.md">Dense</a> layer and the parameters units.<br/>
For example if the input of the layer has a size of [batch_size = 10, input_dim = 5] and units the value 3 then weights will have a size of [input_dim = 5, units = 3].</p>
