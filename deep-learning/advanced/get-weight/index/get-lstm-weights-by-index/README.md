...
<p>Gets the weights of the LSTM layer selected by the index. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/0c/0cabed38dc97-lstm_weights_info.png" alt="lstm_weights_info" width="157" /></p></td>
    </tr>
  </tbody>
</table>
