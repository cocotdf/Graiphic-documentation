...
<p>Gets the weights of the Embedding layer selected by the name. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img alt="Embedding" src="/_assets/shared-images/28/28c79112be20-embedding.png" width="240"/></p>
