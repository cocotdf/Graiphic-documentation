...
<p>Reads and clears all training records stored in the asynchronous FIFO. This VI retrieves the outputs generated during fitting (epoch, iteration, losses, etc.) and allows external monitoring or early stopping of the training loop.</p>

<p align="center"><img src="/_assets/shared-images/8f/8f5b58a587ef-param_asynchronous_fit_fifo_read.png" alt="asynchronous_fit_fifo_read" width="231" /></p>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Fit Outputs : <em>array, </em></strong>contains the training status information read from the FIFO.</td>
    </tr>
    <tr>
      <td></td>
      <td valign="top"><table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/8f/8f5b58a587ef-param_asynchronous_fit_fifo_read.png" alt="param_asynchronous_fit_fifo_read" width="231" /></p></td>
    </tr>
  </tbody>
</table>
