...
<p>Releases the resources allocated for asynchronous fitting. This VI frees the memory used by the FIFO buffer and the internal flag that enables early stopping.</p>

<p align="center"><img src="assets/asynchronous_fit_fifo_close.png" alt="asynchronous_fit_fifo_close" width="247" /></p>
