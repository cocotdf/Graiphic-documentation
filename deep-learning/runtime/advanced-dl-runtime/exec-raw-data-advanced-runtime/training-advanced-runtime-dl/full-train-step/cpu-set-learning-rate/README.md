<h1>Inputs CPU Raw Data (set learning rate)</h1>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>learning rate : <em>float, </em></strong>step size controlling how much to adjust weights during training.</td>
    </tr>
  </tbody>
</table></td>
    </tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_param_training_full_train_step_cpu_2" src="/_assets/shared-images/b3/b34224f8fa2c-input_param_training_full_train_step_cpu.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
