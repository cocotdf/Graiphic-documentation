...
<p>Runs a training step on the model with raw input data from the CPU. This includes the forward and backward pass. The output buffer is allocated automatically.</p>
