...
<p>Runs the inference model with raw input data from the CPU. The output buffer is allocated automatically. The inference model uses stored weights, which are initialized when the Academic Training Session is created and can be updated with the “Update Inference Weights” function.</p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="input_param_inference_forward_cpu" src="/_assets/shared-images/fa/fab1a503539a-input_param_inference_forward_cpu_2.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="output_param_inference_forward_cpu" src="assets/output_param_inference_forward_cpu_2.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
