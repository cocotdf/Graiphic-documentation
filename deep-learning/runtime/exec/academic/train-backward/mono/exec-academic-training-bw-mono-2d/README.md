<h1>Mono Loss Input 2D</h1>

<h2>Description</h2>

<p>Execute train backward with Mono 2D Float Input Data (Academic Training Session).</p>

<p align="center"><img src="assets/exec_academic_training_bw_mono_2d.png" alt="exec_academic_training_bw_mono_2d" width="260" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>2D Loss Input Data : <em>array</em>, </strong>2D array of data with any type : integers (signed/unsigned), floats, doubles, booleans, or strings.</td>
    </tr>
  </tbody>
</table>
