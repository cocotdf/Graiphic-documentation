<h1>Mono Loss Input Scalar</h1>

<h2>Description</h2>

<p>Execute train backward with Mono Scalar Float Input Data (Academic Training Session).</p>

<p align="center"><img src="assets/exec_academic_training_bw_mono_scalar.png" alt="exec_academic_training_bw_mono_scalar" width="260" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>Loss</strong> <strong>Input Data : <em>float</em>, </strong>scalar data with any type : integers (signed/unsigned), floats, doubles, booleans, or strings.</td>
    </tr>
  </tbody>
</table>
