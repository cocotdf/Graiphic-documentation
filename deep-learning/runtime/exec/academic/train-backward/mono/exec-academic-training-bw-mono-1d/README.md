...
<p>Execute train backward with Mono 1D Float Input Data (Academic Training Session).</p>

<p align="center"><img src="assets/exec_academic_training_bw_mono_1d.png" alt="exec_academic_training_bw_mono_1d" width="260" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><strong>1D Loss Input Data : <em>array</em>, </strong>1D array of data with any type : integers (signed/unsigned), floats, doubles, booleans, or strings.</td>
    </tr>
  </tbody>
</table>
