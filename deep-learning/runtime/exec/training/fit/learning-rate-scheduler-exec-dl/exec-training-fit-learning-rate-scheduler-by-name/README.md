...
<p>Fit (loop-style training) the model with a scheduled learning rate, iterating over multi-input data by name within a Training Session, using a pre-configured learning rate scheduler.</p>
