...
<p>Retrieve Mono 5D Output Data (Bool, Int/UInt, Float, or String) (Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/output_training_mono_5d.png" alt="output_training_mono_5d" width="260" /></p>
