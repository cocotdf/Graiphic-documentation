...
<p>Retrieve Mono 6D Output Data (Bool, Int/UInt, Float, or String) (Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/output_training_mono_6d.png" alt="output_training_mono_6d" width="260" /></p>
