...
<p>Retrieve a scalar output tensor (Bool, Int/UInt, Float, or String) from a list of outputs, using its index (Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/output_training_multi_scalar.png" alt="output_training_multi_scalar" width="248" /></p>
