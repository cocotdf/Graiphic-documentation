...
<p>Retrieve a 1D output tensor (Bool, Int/UInt, Float, or String) from a list of outputs, using its index (Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/output_training_multi_1d.png" alt="output_training_multi_1d" width="260" /></p>
