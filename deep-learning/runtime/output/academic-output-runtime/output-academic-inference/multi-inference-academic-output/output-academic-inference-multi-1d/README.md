...
<p>Retrieve a 1D output tensor (Bool, Int/UInt, Float, or String) from a list of outputs, using its index (Academic Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/47/478535330187-output_academic_multi_1d.png" alt="output_academic_multi_1d" width="260" /></p>
