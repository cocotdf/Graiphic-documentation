...
<p>Retrieve a 3D output tensor (Bool, Int/UInt, Float, or String) from a list of outputs, using its index (Academic Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/92/926daced89ad-output_academic_multi_3d.png" alt="output_academic_multi_3d" width="260" /></p>
