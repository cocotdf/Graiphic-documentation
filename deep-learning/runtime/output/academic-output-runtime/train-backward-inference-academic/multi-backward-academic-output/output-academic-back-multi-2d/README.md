...
<p>Retrieve a 2D output tensor (Bool, Int/UInt, Float, or String) from a list of outputs, using its index (Academic Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/42/42872a7942d5-output_academic_multi_2d.png" alt="output_academic_multi_2d" width="260" /></p>
