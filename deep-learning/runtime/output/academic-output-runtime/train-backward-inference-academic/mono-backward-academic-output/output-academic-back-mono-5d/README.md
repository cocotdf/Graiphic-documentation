...
<p>Retrieve Mono 5D Output Data (Bool, Int/UInt, Float, or String) (Academic Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/70/701b6667972e-output_academic_mono_5d.png" alt="output_academic_mono_5d" width="260" /></p>
