...
<p>Retrieve a 5D output tensor (Bool, Int/UInt, Float, or String) from a list of outputs, using its index (Academic Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/e0/e05c5aad0c30-output_academic_multi_5d.png" alt="output_academic_multi_5d" width="260" /></p>
