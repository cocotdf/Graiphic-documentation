...
<p>Retrieve a 6D output tensor (Bool, Int/UInt, Float, or String) from a list of outputs, using its index (Academic Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="/_assets/shared-images/89/8955712e9b09-output_academic_multi_6d.png" alt="output_academic_multi_6d" width="260" /></p>
