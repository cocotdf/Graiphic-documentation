...
<p align="center"><img src="assets/get-model-info.png" alt="Get Model Info" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="model_id" src="assets/cstr.png" width="42"/></td>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="display_name" src="assets/istr.png" width="42"/></td>
      <td valign="top"><strong>display_name : <em>string</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="created_at" src="assets/istr.png" width="42"/></td>
