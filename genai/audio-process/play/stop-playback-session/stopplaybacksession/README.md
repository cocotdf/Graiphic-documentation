<h1>StopPlaybackSession</h1>

<h2>Description</h2>

<p>Stops file playback then delete the file playback handle. Type : VI.</p>

<p align="center"><img src="assets/stopplaybacksession.png" alt="StopPlaybackSession" width="270" /></p>
