...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="repeat penalty" src="assets/csgl.png" width="42"/></td>
      <td valign="top"><strong>repeat penalty : <em>float</em></strong></td>
    </tr>
  </tbody>
</table>
