<h1>Session And Sample</h1>

<h2>Description</h2>

<p>Initialize a session and its sampler Type : polymorphic.</p>

<p align="center"><img src="assets/session-and-sample.png" alt="Session And Sample" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="enable reasoning" src="assets/cbool.png" width="42"/></td>
      <td valign="top"><strong>enable reasoning : <em>boolean</em></strong></td>
    </tr>
    <tr>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="MultiModal out" src="assets/iMultiModallvclass.png" width="42"/></td>
