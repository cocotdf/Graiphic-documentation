...
<p>To access some API functions, you must send an OpenAI-Beta request header. Type : VI.</p>

<p align="center"><img src="assets/set-beta.png" alt="Set Beta" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="beta" src="/_assets/shared-images/71/714be290bc5b-cstr.png" width="42"/></td>
