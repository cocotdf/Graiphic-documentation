...
<p align="center"><img src="assets/upload-file.png" alt="Upload File" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="file_path" src="/_assets/shared-images/09/0971eb44b0da-cpath.png" width="42"/></td>
      <td valign="top"><strong>file_path : <em>path</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="purpose" src="/_assets/shared-images/71/714be290bc5b-cstr.png" width="42"/></td>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="file" src="/_assets/shared-images/48/48b3dacdc8e3-icclst.png" width="32"/> <strong>file : <em>cluster</em></strong></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="purpose" src="/_assets/shared-images/6d/6d824f6de01c-istr.png" width="42"/></td>
      <td valign="top"><strong>purpose : <em>string</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="filename" src="/_assets/shared-images/6d/6d824f6de01c-istr.png" width="42"/></td>
      <td valign="top"><strong>filename : <em>string</em></strong></td>
    </tr>
    <tr>
      <td width="64" valign="top"><img alt="bytes" src="/_assets/shared-images/92/9299e581eae9-ii32.png" width="42"/></td>
    ...
    <tr>
      <td width="64" valign="top"><img alt="status_details" src="/_assets/shared-images/6d/6d824f6de01c-istr.png" width="42"/></td>
      <td valign="top"><strong>status_details : <em>string</em></strong></td>
    </tr>
  </tbody>
</table>
      </td>
      <td valign="top" width="30%"><p align="center"><img alt="file" src="/_assets/shared-images/bd/bdf37ca96366-file_info.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
