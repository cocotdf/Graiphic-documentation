...
<p>Returns all messages for a given thread. Type : VI.</p>

<p align="center"><img src="assets/get-all-messages.png" alt="Get All Messages" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="all_messages" src="/_assets/shared-images/c4/c4de9f5441d0-i1dstr.png" width="42"/></td>
      <td valign="top"><strong>all_messages : <em>array of string</em></strong>
<ul>
  <li><img alt="delimited string" src="/_assets/shared-images/6d/6d824f6de01c-istr.png" width="32"/> <strong>delimited string : <em>string</em></strong></li>
</ul></td>
    </tr>
  </tbody>
</table>
