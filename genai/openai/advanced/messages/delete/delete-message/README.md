...
<p>Deletes a message. Type : VI.</p>

<p align="center"><img src="assets/delete-message.png" alt="Delete Message" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="message_status" src="assets/icclst.png" width="32"/> <strong>message_status : <em>cluster</em></strong></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="message_status" src="assets/message_status.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
