<h1>Delete Vector Store</h1>

<h2>Description</h2>

<p>Type : VI.</p>

<p align="center"><img src="assets/delete-vector-store.png" alt="Delete Vector Store" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="vector_store_status" src="/_assets/shared-images/48/48b3dacdc8e3-icclst.png" width="32"/> <strong>vector_store_status : <em>cluster</em></strong></p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="vector_store_status" src="/_assets/shared-images/46/4648eef9a862-assistant_status.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
