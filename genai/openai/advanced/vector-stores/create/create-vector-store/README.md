...
<p align="center"><img src="assets/create-vector-store.png" alt="Create Vector Store" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="file_ids (optional)" src="/_assets/shared-images/ce/ceeb813734df-c1dstr.png" width="42"/></td>
      <td valign="top"><strong>file_ids (optional) : <em>array of string</em></strong>
<ul>
...
<ul>
  ...
  <li><img alt="days (required)" src="/_assets/shared-images/4b/4b060a6ee305-cu32.png" width="32"/> <strong>days (required) : <em>integer</em></strong></li>
    ...
    <tr>
      <td width="64" valign="top"><img alt="chunking_strategy (optional)" src="/_assets/shared-images/d0/d02f3e0bb4c0-cgguflvclass.png" width="42"/></td>
      <td valign="top"><strong>chunking_strategy (optional) : <em>class</em></strong></td>
    </tr>
    <tr>
