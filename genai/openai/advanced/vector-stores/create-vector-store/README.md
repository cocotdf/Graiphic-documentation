...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="file_ids (optional)" src="assets/c1dstr.png" width="42"/></td>
...
<ul>
  ...
  <li><img alt="days (required)" src="assets/cu32.png" width="32"/> <strong>days (required) : <em>integer</em></strong></li>
    ...
    <tr>
      <td width="64" valign="top"><img alt="chunking_strategy (optional)" src="assets/cchunking__strategylvclass.png" width="42"/></td>
