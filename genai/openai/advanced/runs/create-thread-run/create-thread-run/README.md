<h1>Create Thread &amp; Run</h1>

<h2>Description</h2>

<p>Type : VI.</p>

<p align="center"><img src="assets/create-thread-run.png" alt="Create Thread &amp; Run" width="270" /></p>
...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="thread (optional)" src="/_assets/shared-images/d3/d34232a0665a-c1dcclst.png" width="42"/></td>
      <td valign="top"><strong>thread (optional) : <em>array of cluster</em></strong>
<ul>
...
<ul>
  ...
  <li><img alt="metadata" src="/_assets/shared-images/d0/d02f3e0bb4c0-cgguflvclass.png" width="32"/> <strong>metadata : <em>class</em></strong></li>
    ...
    <tr>
      <td width="64" valign="top"><img alt="tool_resources.lvclass" src="/_assets/shared-images/d0/d02f3e0bb4c0-cgguflvclass.png" width="42"/></td>
      <td valign="top"><strong>tool_resources.lvclass : <em>class</em></strong></td>
    </tr>
    <tr>
