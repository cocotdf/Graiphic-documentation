...
<table>
  <tbody>
    ...
    <tr>
      <td width="64" valign="top"><img alt="thread (optional)" src="assets/c1dcclst.png" width="42"/></td>
...
<ul>
  ...
  <li><img alt="metadata" src="assets/cmetadatalvclass.png" width="32"/> <strong>metadata : <em>class</em></strong></li>
    ...
    <tr>
      <td width="64" valign="top"><img alt="tool_resources.lvclass" src="assets/ctool__resourceslvclass.png" width="42"/></td>
