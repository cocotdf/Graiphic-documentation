...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="tool_outputs (required)" src="assets/c1dcclst.png" width="42"/></td>
      <td valign="top"><strong>tool_outputs (required) : <em>array of cluster</em></strong>
<ul>
  <li><img alt="tool_call_id" src="assets/cstr.png" width="32"/> <strong>tool_call_id : <em>string</em></strong></li>
  <li><img alt="output" src="assets/cstr.png" width="32"/> <strong>output : <em>string</em></strong></li>
</ul></td>
    </tr>
    <tr>
