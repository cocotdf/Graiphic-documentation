...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="code_interpreter" src="assets/icclst.png" width="42"/></td>
      <td valign="top"><strong>code_interpreter : <em>cluster</em></strong>
<ul>
  <li><img alt="file_ids" src="assets/i1dstr.png" width="32"/> <strong>file_ids : <em>array of string</em></strong>
<ul>
