...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Model in : <em>object, </em></strong>the ONNX object serves as the parent class that provides the core structure and functionalities shared by Inference.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/2f/2f8a022200ec-acc_execution_open_graph_default_parameter.png" alt="acc_execution_open_graph_default_parameter" width="208" /></p></td>
    </tr>
  </tbody>
</table>
...
<li>4–5 = best performance, longer build time</li>
  ...
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="Input_Array_Path.Png" src="/_assets/shared-images/ce/ce56d69b953b-input_array_path.png" width="42"/></td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/3d/3d31b7dbbed8-acc_execution_open_graph_tensor-rt_parameter.png" alt="acc_execution_open_graph_tensor-rt_parameter" width="200" /></p></td>
    </tr>
  </tbody>
</table>
