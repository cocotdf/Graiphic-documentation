...
<p>Generate the ONNX Graph then create a DirectML Session from it. Type : polymorphic.</p>
<p align="center"><img src="/_assets/shared-images/7e/7e9f58f7c706-cpu.png" alt="DirectML" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="Model in" src="/_assets/shared-images/26/26bd4fbca456-cacc__modellvclass.png" width="42"/></td>
