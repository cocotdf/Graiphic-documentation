...
<p>Create DirectML Session with its Session Options on the stored local Env. Type : polymorphic.</p>
<p align="center"><img src="assets/directml.png" alt="DirectML" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="model_path" src="assets/cpath.png" width="42"/></td>
