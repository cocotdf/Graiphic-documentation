...
<p>Adds to the ptr input array a 4D array (of type <strong>BOOL</strong>, <strong>SGL</strong>, <strong>INT</strong>, <strong>UINT</strong>, or <strong>STRING</strong>) at a specified name. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/acc_execution_cuda-advanced_construct-ptr_name_4d.png" alt="Acc_Execution_Cuda Advanced_Construct Ptr_Name_4D.Png" width="243" /></p>
