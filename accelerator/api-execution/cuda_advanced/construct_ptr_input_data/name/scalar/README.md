...
<p>Adds to the ptr input array a scalar (of type <strong>BOOL</strong>, <strong>SGL</strong>, <strong>INT</strong>, <strong>UINT</strong>, or <strong>STRING</strong>) at a specified name. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/acc_execution_cuda-advanced_construct-ptr_name_scalar.png" alt="Acc_Execution_Cuda Advanced_Construct Ptr_Name_Scalar.Png" width="232" /></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>Input Data : <em>float</em>, </strong>scalar with any type : integers (signed/unsigned), floats, doubles, booleans, or strings.</td>
    </tr>
  </tbody>
</table>
