...
<p>Adds to the ptr input array a 1D array (of type <strong>BOOL</strong>, <strong>SGL</strong>, <strong>INT</strong>, <strong>UINT</strong>, or <strong>STRING</strong>) at a specified index. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/acc_execution_cuda-advanced_construct-ptr_index_1d.png" alt="Acc_Execution_Cuda Advanced_Construct Ptr_Index_1D.Png" width="243" /></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>1D Input Data : <em>array</em>, </strong>1D array of data with any type : integers (signed/unsigned), floats, doubles, booleans, or strings.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" width="30%"><p align="center"><img src="/_assets/shared-images/a4/a4f12e4fbbd3-acc_execution_cuda-advanced_multi_preallocated_input_parameter.png" alt="acc_execution_cuda-advanced_multi_preallocated_input_parameter" width="231" /></p></td>
    </tr>
  </tbody>
</table>
