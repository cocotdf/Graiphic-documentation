...
<p>Adds to the ptr input array a 2D array (of type <strong>BOOL</strong>, <strong>SGL</strong>, <strong>INT</strong>, <strong>UINT</strong>, or <strong>STRING</strong>) at a specified index. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/acc_execution_cuda-advanced_construct-ptr_index_2d.png" alt="Acc_Execution_Cuda Advanced_Construct Ptr_Index_2D.Png" width="243" /></p>
