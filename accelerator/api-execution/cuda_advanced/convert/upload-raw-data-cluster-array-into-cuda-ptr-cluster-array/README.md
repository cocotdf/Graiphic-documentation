<h1>Upload Raw Data Cluster Array Into CUDA Ptr Cluster Array</h1>
...
<p align="center"><img src="assets/upload-raw-data-cluster-array-into-cuda-ptr-cluster-array.png" alt="Upload Raw Data Cluster Array Into CUDA Ptr Cluster Array" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="CUDA Data" src="/_assets/shared-images/d3/d34232a0665a-c1dcclst.png" width="32"/> <strong>CUDA Data : <em>array of cluster</em></strong></p>
...
<ul>
  ...
  <li><img alt="inputs_types" src="/_assets/shared-images/7f/7f7e66ba54dc-cenum.png" width="32"/> <strong>inputs_types : <em>enum</em></strong></li>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="CUDA Data" src="assets/CUDA Data.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="Dup CUDA Data" src="/_assets/shared-images/fc/fcb3fe7c9ca3-i1dcclst.png" width="32"/> <strong>Dup CUDA Data : <em>array of cluster</em></strong></p>
...
<ul>
  ...
  <li><img alt="inputs_types" src="/_assets/shared-images/b4/b48b0be5e324-ienum.png" width="32"/> <strong>inputs_types : <em>enum</em></strong></li>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="Dup CUDA Data" src="assets/Dup CUDA Data.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
