...
<p>This function copy the data stored inside cuda ptr to store it locally in LabVIEW arrays. Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/acc_execution_cuda-advanced_function_copy-cuda.png" alt="Acc_Execution_Cuda Advanced_Function_Copy Cuda.Png" width="263" /></p>
