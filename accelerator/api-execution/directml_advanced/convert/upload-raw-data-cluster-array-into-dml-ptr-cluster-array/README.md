<h1>Upload Raw Data Cluster Array Into DML Ptr Cluster Array</h1>

<h2>Description</h2>

<p>Upload data from CPU Data into DirectML Data when both input_order match. Warning : You need to link a valid DirectML Execution Session. Type : polymorphic.</p>
<p align="center"><img src="assets/upload-raw-data-cluster-array-into-dml-ptr-cluster-array.png" alt="Upload Raw Data Cluster Array Into DML Ptr Cluster Array" width="270" /></p>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="CPU Data" src="/_assets/shared-images/d3/d34232a0665a-c1dcclst.png" width="32"/> <strong>CPU Data : <em>array of cluster</em></strong></p>
...
<ul>
  <li><img alt="dtype" src="/_assets/shared-images/7f/7f7e66ba54dc-cenum.png" width="32"/> <strong>dtype : <em>enum</em></strong></li>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="CPU Data" src="/_assets/shared-images/d2/d2e34917f749-cpu-data.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="DirectML Data" src="/_assets/shared-images/d3/d34232a0665a-c1dcclst.png" width="32"/> <strong>DirectML Data : <em>array of cluster</em></strong></p>
...
<ul>
  ...
  <li><img alt="Inputs Info" src="/_assets/shared-images/1a/1a7a9a6249a8-ccclst.png" width="32"/> <strong>Inputs Info : <em>cluster</em></strong>
<ul>
  <li><img alt="inputs_ptr" src="/_assets/shared-images/87/87318a9cc128-cu64.png" width="32"/> <strong>inputs_ptr : <em>integer</em></strong></li>
  <li><img alt="inputs_shapes" src="/_assets/shared-images/a4/a466ab17832c-c1di64.png" width="32"/> <strong>inputs_shapes : <em>array of integer</em></strong>
<ul>
  <li><img alt="Numeric" src="/_assets/shared-images/b6/b6c25b5c1c13-ci64.png" width="32"/> <strong>Numeric : <em>integer</em></strong></li>
</ul></li>
  <li><img alt="inputs_ranks" src="/_assets/shared-images/b6/b6c25b5c1c13-ci64.png" width="32"/> <strong>inputs_ranks : <em>integer</em></strong></li>
  <li><img alt="inputs_types" src="/_assets/shared-images/7f/7f7e66ba54dc-cenum.png" width="32"/> <strong>inputs_types : <em>enum</em></strong></li>
</ul></li>
</ul></td>
    </tr>
  </tbody>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="DirectML Data" src="assets/DirectML Data.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="Dup DirectML Data" src="/_assets/shared-images/fc/fcb3fe7c9ca3-i1dcclst.png" width="32"/> <strong>Dup DirectML Data : <em>array of cluster</em></strong></p>
...
<ul>
  ...
  <li><img alt="inputs_types" src="/_assets/shared-images/b4/b48b0be5e324-ienum.png" width="32"/> <strong>inputs_types : <em>enum</em></strong></li>
      ...
      <td valign="top" width="30%"><p align="center"><img alt="Dup DirectML Data" src="assets/Dup DirectML Data.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
