...
<p>Retrieve Mono 6D Output Data (Bool, Int/UInt, Float, or String) (Inference Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/acc_execution_output_mono_6d.png" alt="acc_execution_output_mono_6d" width="260" /></p>
