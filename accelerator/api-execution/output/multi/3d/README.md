...
<p>Retrieve Multi 3D Output Data (Bool, Int/UInt, Float, or String) (Inference Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/acc_execution_output_multi_3d.png" alt="acc_execution_output_multi_3d" width="260" /></p>
