...
<p>Truncates the input to the next lowest integer.</p>

<p align="center"><img src="/_assets/shared-images/df/df3fa67d901d-round_toward_less_inf.png" alt="Round_Toward_Less_Inf.Png" width="171" /></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>floor(x) : <em>class,</em></strong> the resulting lowest integer, closest to x.</td>
    </tr>
  </tbody>
</table>
...
<p align="center"><img src="assets/ex_round_toward_minus_infinity.png" alt="ex_round_toward_minus_infinity" width="260" /></p>
