...
<p>Concatenate arrays to an n-dimensional array.</p>

<p><strong>Warning : A new tensor is created for the output.</strong></p>

<p align="center"><img src="/_assets/shared-images/a7/a7837629bad1-concatenate_array.png" alt="Concatenate_Array.Png" width="254" /></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>concatenated array : <em>class,</em></strong> the resulting.</td>
    </tr>
  </tbody>
</table>
...
<p align="center"><img src="assets/ex_concat_array.png" alt="ex_concat_array" width="260" /></p>
