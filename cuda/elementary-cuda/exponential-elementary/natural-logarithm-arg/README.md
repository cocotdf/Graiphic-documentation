<h1>Natural Logarithm (Arg + 1)</h1>

<h2>Description</h2>

<p>Computes the natural logarithm of (x + 1).</p>

<p align="center"><img src="/_assets/shared-images/dc/dc2ff1a8837a-natural_logarithm_arg_plus_one.png" alt="Natural_Logarithm_Arg_Plus_One.Png" width="170" /></p>
...
<table>
  <tbody>
    <tr>
      ...
      <td valign="top"><strong>ln(x+1) : <em>class,</em></strong> the natural logarithm of (x + 1).</td>
    </tr>
  </tbody>
</table>
...
<p align="center"><img src="assets/ex_ln_arg_plus_1.png" alt="ex_ln_arg_plus_1" width="260" /></p>
