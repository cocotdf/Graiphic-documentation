...
<p>Computes both the sine and cosine of x, where x is in radians. Use this function only when you need both results.</p>
...
<p align="center"><img src="assets/ex_sine_and_cosine.png" alt="ex_sine_and_cosine" width="260" /></p>
